...
*|*
*+-- riscv-target*
*| +-- riscvOVPsim*     // target that can runs the test suites
*| | +-- device*        // devices to be tested
*| | | +-- rv32i*       // configuration of the simulator for the specific device
*| | | | |-- Makefile.include*     // specific run command 
*| | | +-- compliance_io.h* // macro implementation for this target
*| | *
*| |*
*| +-- spike*     // target that can runs the test suites
*| | +-- device*        // devices to be tested
*| | | +-- rv32i*       // configuration of the simulator for the specific device
*| | | | |-- Makefile.include*     // specific run command 
*| | | +-- compliance_io.h* // macro implementation for this target
