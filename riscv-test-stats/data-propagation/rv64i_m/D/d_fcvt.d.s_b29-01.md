...
Last Coverpoint : ['rs1 : f18', 'rd : f1']
Last Code Sequence : 
	-[0x80000688]:fcvt.d.s ft1, fs2, rne
	-[0x8000068c]:csrrs a7, fflags, zero
	-[0x80000690]:fsd ft1, 480(a5)
Current Store : [0x80000694] : sd a7, 488(a5) -- Store: [0x800024f8]:0x0000000000000000




Last Coverpoint : ['rs1 : f16', 'rd : f26']
Last Code Sequence : 
	-[0x800006a0]:fcvt.d.s fs10, fa6, rne
...
|---:|----------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------|
|   1|[0x80002310]<br>0xEEDBEADFEEDBEADF|- opcode : fcvt.d.s<br> - rs1 : f2<br> - rd : f29<br> - rs1 != rd<br> - fs1 == 0 and fe1 == 0x3fc and fm1 == 0x08574923b8698 and rm_val == 0  #nosat<br> |[0x800003b8]:fcvt.d.s ft9, ft2, rne<br> [0x800003bc]:csrrs a7, fflags, zero<br> [0x800003c0]:fsd ft9, 0(a5)<br>     |
|   2|[0x80002320]<br>0x0000000080000390|- rs1 : f5<br> - rd : f5<br> - rs1 == rd<br> - fs1 == 1 and fe1 == 0x3fc and fm1 == 0x08574923b869f and rm_val == 0  #nosat<br>                          |[0x800003d0]:fcvt.d.s ft5, ft5, rne<br> [0x800003d4]:csrrs a7, fflags, zero<br> [0x800003d8]:fsd ft5, 16(a5)<br>    |
|   3|[0x80002330]<br>0xDBEADFEEDBEADFEE|- rs1 : f13<br> - rd : f21<br> - fs1 == 1 and fe1 == 0x3fc and fm1 == 0x08574923b869e and rm_val == 0  #nosat<br>                                        |[0x800003e8]:fcvt.d.s fs5, fa3, rne<br> [0x800003ec]:csrrs a7, fflags, zero<br> [0x800003f0]:fsd fs5, 32(a5)<br>    |
|   4|[0x80002340]<br>0xAB7FBB6FAB7FBB6F|- rs1 : f7<br> - rd : f11<br> - fs1 == 1 and fe1 == 0x3fc and fm1 == 0x08574923b869d and rm_val == 0  #nosat<br>                                         |[0x80000400]:fcvt.d.s fa1, ft7, rne<br> [0x80000404]:csrrs a7, fflags, zero<br> [0x80000408]:fsd fa1, 48(a5)<br>    |
|   5|[0x80002350]<br>0x0000000A00006000|- rs1 : f22<br> - rd : f2<br> - fs1 == 1 and fe1 == 0x3fc and fm1 == 0x08574923b869c and rm_val == 0  #nosat<br>                                         |[0x80000418]:fcvt.d.s ft2, fs6, rne<br> [0x8000041c]:csrrs a7, fflags, zero<br> [0x80000420]:fsd ft2, 64(a5)<br>    |
|   6|[0x80002360]<br>0xBFDDB7D5BFDDB7D5|- rs1 : f23<br> - rd : f4<br> - fs1 == 1 and fe1 == 0x3fc and fm1 == 0x08574923b869b and rm_val == 0  #nosat<br>                                         |[0x80000430]:fcvt.d.s ft4, fs7, rne<br> [0x80000434]:csrrs a7, fflags, zero<br> [0x80000438]:fsd ft4, 80(a5)<br>    |
|   7|[0x80002370]<br>0xB7FBB6FAB7FBB6FA|- rs1 : f26<br> - rd : f7<br> - fs1 == 1 and fe1 == 0x3fc and fm1 == 0x08574923b869a and rm_val == 0  #nosat<br>                                         |[0x80000448]:fcvt.d.s ft7, fs10, rne<br> [0x8000044c]:csrrs a7, fflags, zero<br> [0x80000450]:fsd ft7, 96(a5)<br>   |
|   8|[0x80002380]<br>0xFBB6FAB7FBB6FAB7|- rs1 : f25<br> - rd : f31<br> - fs1 == 1 and fe1 == 0x3fc and fm1 == 0x08574923b8699 and rm_val == 0  #nosat<br>                                        |[0x80000460]:fcvt.d.s ft11, fs9, rne<br> [0x80000464]:csrrs a7, fflags, zero<br> [0x80000468]:fsd ft11, 112(a5)<br> |
|   9|[0x80002390]<br>0x0000000000000000|- rs1 : f4<br> - rd : f17<br> - fs1 == 1 and fe1 == 0x3fc and fm1 == 0x08574923b8698 and rm_val == 0  #nosat<br>                                         |[0x80000478]:fcvt.d.s fa7, ft4, rne<br> [0x8000047c]:csrrs a7, fflags, zero<br> [0x80000480]:fsd fa7, 128(a5)<br>   |
|  10|[0x800023a0]<br>0x0000000080002310|- rs1 : f6<br> - rd : f15<br> - fs1 == 0 and fe1 == 0x3fc and fm1 == 0x08574923b869f and rm_val == 0  #nosat<br>                                         |[0x80000490]:fcvt.d.s fa5, ft6, rne<br> [0x80000494]:csrrs a7, fflags, zero<br> [0x80000498]:fsd fa5, 144(a5)<br>   |
|  11|[0x800023b0]<br>0x0000000080002010|- rs1 : f17<br> - rd : f16<br> - fs1 == 0 and fe1 == 0x3fc and fm1 == 0x08574923b869e and rm_val == 0  #nosat<br>                                        |[0x800004a8]:fcvt.d.s fa6, fa7, rne<br> [0x800004ac]:csrrs a7, fflags, zero<br> [0x800004b0]:fsd fa6, 160(a5)<br>   |
|  12|[0x800023c0]<br>0xDDB7D5BFDDB7D5BF|- rs1 : f3<br> - rd : f28<br> - fs1 == 0 and fe1 == 0x3fc and fm1 == 0x08574923b869d and rm_val == 0  #nosat<br>                                         |[0x800004c0]:fcvt.d.s ft8, ft3, rne<br> [0x800004c4]:csrrs a7, fflags, zero<br> [0x800004c8]:fsd ft8, 176(a5)<br>   |
|  13|[0x800023d0]<br>0xB6FAB7FBB6FAB7FB|- rs1 : f11<br> - rd : f23<br> - fs1 == 0 and fe1 == 0x3fc and fm1 == 0x08574923b869c and rm_val == 0  #nosat<br>                                        |[0x800004d8]:fcvt.d.s fs7, fa1, rne<br> [0x800004dc]:csrrs a7, fflags, zero<br> [0x800004e0]:fsd fs7, 192(a5)<br>   |
|  14|[0x800023e0]<br>0x6DF56FF76DF56FF7|- rs1 : f30<br> - rd : f22<br> - fs1 == 0 and fe1 == 0x3fc and fm1 == 0x08574923b869b and rm_val == 0  #nosat<br>                                        |[0x800004f0]:fcvt.d.s fs6, ft10, rne<br> [0x800004f4]:csrrs a7, fflags, zero<br> [0x800004f8]:fsd fs6, 208(a5)<br>  |
|  15|[0x800023f0]<br>0xD5BFDDB7D5BFDDB7|- rs1 : f9<br> - rd : f12<br> - fs1 == 0 and fe1 == 0x3fc and fm1 == 0x08574923b869a and rm_val == 0  #nosat<br>                                         |[0x80000508]:fcvt.d.s fa2, fs1, rne<br> [0x8000050c]:csrrs a7, fflags, zero<br> [0x80000510]:fsd fa2, 224(a5)<br>   |
|  16|[0x80002400]<br>0xBB6FAB7FBB6FAB7F|- rs1 : f19<br> - rd : f27<br> - fs1 == 0 and fe1 == 0x3fc and fm1 == 0x08574923b8699 and rm_val == 0  #nosat<br>                                        |[0x80000520]:fcvt.d.s fs11, fs3, rne<br> [0x80000524]:csrrs a7, fflags, zero<br> [0x80000528]:fsd fs11, 240(a5)<br> |
|  17|[0x80002410]<br>0x0000000080002000|- rs1 : f31<br> - rd : f6<br>                                                                                                                            |[0x80000538]:fcvt.d.s ft6, ft11, rne<br> [0x8000053c]:csrrs a7, fflags, zero<br> [0x80000540]:fsd ft6, 256(a5)<br>  |
|  18|[0x80002420]<br>0xB7D5BFDDB7D5BFDD|- rs1 : f8<br> - rd : f20<br>                                                                                                                            |[0x80000550]:fcvt.d.s fs4, fs0, rne<br> [0x80000554]:csrrs a7, fflags, zero<br> [0x80000558]:fsd fs4, 272(a5)<br>   |
|  19|[0x80002430]<br>0x56FF76DF56FF76DF|- rs1 : f1<br> - rd : f10<br>                                                                                                                            |[0x80000568]:fcvt.d.s fa0, ft1, rne<br> [0x8000056c]:csrrs a7, fflags, zero<br> [0x80000570]:fsd fa0, 288(a5)<br>   |
|  20|[0x80002440]<br>0x0000000000000000|- rs1 : f20<br> - rd : f0<br>                                                                                                                            |[0x80000580]:fcvt.d.s ft0, fs4, rne<br> [0x80000584]:csrrs a7, fflags, zero<br> [0x80000588]:fsd ft0, 304(a5)<br>   |
|  21|[0x80002450]<br>0xDF56FF76DF56FF76|- rs1 : f21<br> - rd : f18<br>                                                                                                                           |[0x80000598]:fcvt.d.s fs2, fs5, rne<br> [0x8000059c]:csrrs a7, fflags, zero<br> [0x800005a0]:fsd fs2, 320(a5)<br>   |
|  22|[0x80002460]<br>0xDB7D5BFDDB7D5BFD|- rs1 : f29<br> - rd : f24<br>                                                                                                                           |[0x800005b0]:fcvt.d.s fs8, ft9, rne<br> [0x800005b4]:csrrs a7, fflags, zero<br> [0x800005b8]:fsd fs8, 336(a5)<br>   |
|  23|[0x80002470]<br>0xF76DF56FF76DF56F|- rs1 : f24<br> - rd : f30<br>                                                                                                                           |[0x800005c8]:fcvt.d.s ft10, fs8, rne<br> [0x800005cc]:csrrs a7, fflags, zero<br> [0x800005d0]:fsd ft10, 352(a5)<br> |
|  24|[0x80002480]<br>0x0000000A00000000|- rs1 : f0<br> - rd : f3<br>                                                                                                                             |[0x800005e0]:fcvt.d.s ft3, ft0, rne<br> [0x800005e4]:csrrs a7, fflags, zero<br> [0x800005e8]:fsd ft3, 368(a5)<br>   |
|  25|[0x80002490]<br>0xADFEEDBEADFEEDBE|- rs1 : f15<br> - rd : f9<br>                                                                                                                            |[0x800005f8]:fcvt.d.s fs1, fa5, rne<br> [0x800005fc]:csrrs a7, fflags, zero<br> [0x80000600]:fsd fs1, 384(a5)<br>   |
|  26|[0x800024a0]<br>0x6FAB7FBB6FAB7FBB|- rs1 : f14<br> - rd : f19<br>                                                                                                                           |[0x80000610]:fcvt.d.s fs3, fa4, rne<br> [0x80000614]:csrrs a7, fflags, zero<br> [0x80000618]:fsd fs3, 400(a5)<br>   |
|  27|[0x800024b0]<br>0xF56FF76DF56FF76D|- rs1 : f28<br> - rd : f14<br>                                                                                                                           |[0x80000628]:fcvt.d.s fa4, ft8, rne<br> [0x8000062c]:csrrs a7, fflags, zero<br> [0x80000630]:fsd fa4, 416(a5)<br>   |
|  28|[0x800024c0]<br>0x5BFDDB7D5BFDDB7D|- rs1 : f10<br> - rd : f8<br>                                                                                                                            |[0x80000640]:fcvt.d.s fs0, fa0, rne<br> [0x80000644]:csrrs a7, fflags, zero<br> [0x80000648]:fsd fs0, 432(a5)<br>   |
