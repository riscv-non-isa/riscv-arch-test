...
|---:|----------------------------------|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|
|   1|[0x80002310]<br>0x0000000000000000|- opcode : fcvt.lu.d<br> - rd : x14<br> - rs1 : f7<br> - fs1 == 0 and fe1 == 0x000 and fm1 == 0x0000000000000 and rm_val == 0  #nosat<br> |[0x800003b8]:fcvt.lu.d a4, ft7, dyn<br> [0x800003bc]:csrrs a7, fflags, zero<br> [0x800003c0]:sd a4, 0(a5)<br>      |
|   2|[0x80002320]<br>0x0000000000000000|- rd : x4<br> - rs1 : f18<br> - fs1 == 1 and fe1 == 0x3f8 and fm1 == 0x0000000000000 and rm_val == 0  #nosat<br>                          |[0x800003d0]:fcvt.lu.d tp, fs2, dyn<br> [0x800003d4]:csrrs a7, fflags, zero<br> [0x800003d8]:sd tp, 16(a5)<br>     |
|   3|[0x80002330]<br>0x0000000000000001|- rd : x12<br> - rs1 : f11<br> - fs1 == 0 and fe1 == 0x3ff and fm1 == 0x0000000000000 and rm_val == 0  #nosat<br>                         |[0x800003e8]:fcvt.lu.d a2, fa1, dyn<br> [0x800003ec]:csrrs a7, fflags, zero<br> [0x800003f0]:sd a2, 32(a5)<br>     |
|   4|[0x80002340]<br>0xFFFFFFFFFFFFFFFF|- rd : x11<br> - rs1 : f20<br> - fs1 == 1 and fe1 == 0x7ff and fm1 == 0x0000000000001 and rm_val == 0  #nosat<br>                         |[0x80000400]:fcvt.lu.d a1, fs4, dyn<br> [0x80000404]:csrrs a7, fflags, zero<br> [0x80000408]:sd a1, 48(a5)<br>     |
|   5|[0x80002350]<br>0xFFFFFFFFFFFFFFFF|- rd : x29<br> - rs1 : f29<br> - fs1 == 0 and fe1 == 0x7ff and fm1 == 0x0000000000001 and rm_val == 0  #nosat<br>                         |[0x80000418]:fcvt.lu.d t4, ft9, dyn<br> [0x8000041c]:csrrs a7, fflags, zero<br> [0x80000420]:sd t4, 64(a5)<br>     |
|   6|[0x80002360]<br>0xFFFFFFFFFFFFFFFF|- rd : x10<br> - rs1 : f9<br> - fs1 == 1 and fe1 == 0x7ff and fm1 == 0x8000000000001 and rm_val == 0  #nosat<br>                          |[0x80000430]:fcvt.lu.d a0, fs1, dyn<br> [0x80000434]:csrrs a7, fflags, zero<br> [0x80000438]:sd a0, 80(a5)<br>     |
|   7|[0x80002370]<br>0xFFFFFFFFFFFFFFFF|- rd : x21<br> - rs1 : f1<br> - fs1 == 0 and fe1 == 0x7ff and fm1 == 0x8000000000001 and rm_val == 0  #nosat<br>                          |[0x80000448]:fcvt.lu.d s5, ft1, dyn<br> [0x8000044c]:csrrs a7, fflags, zero<br> [0x80000450]:sd s5, 96(a5)<br>     |
|   8|[0x80002380]<br>0xFFFFFFFFFFFFFFFF|- rd : x30<br> - rs1 : f26<br> - fs1 == 1 and fe1 == 0x7ff and fm1 == 0x8000000000000 and rm_val == 0  #nosat<br>                         |[0x80000460]:fcvt.lu.d t5, fs10, dyn<br> [0x80000464]:csrrs a7, fflags, zero<br> [0x80000468]:sd t5, 112(a5)<br>   |
|   9|[0x80002390]<br>0xFFFFFFFFFFFFFFFF|- rd : x5<br> - rs1 : f0<br> - fs1 == 0 and fe1 == 0x7ff and fm1 == 0x8000000000000 and rm_val == 0  #nosat<br>                           |[0x80000478]:fcvt.lu.d t0, ft0, dyn<br> [0x8000047c]:csrrs a7, fflags, zero<br> [0x80000480]:sd t0, 128(a5)<br>    |
|  10|[0x800023a0]<br>0x0000000000000000|- rd : x26<br> - rs1 : f3<br> - fs1 == 1 and fe1 == 0x7ff and fm1 == 0x0000000000000 and rm_val == 0  #nosat<br>                          |[0x80000490]:fcvt.lu.d s10, ft3, dyn<br> [0x80000494]:csrrs a7, fflags, zero<br> [0x80000498]:sd s10, 144(a5)<br>  |
|  11|[0x800023b0]<br>0xFFFFFFFFFFFFFFFF|- rd : x23<br> - rs1 : f17<br> - fs1 == 0 and fe1 == 0x7ff and fm1 == 0x0000000000000 and rm_val == 0  #nosat<br>                         |[0x800004a8]:fcvt.lu.d s7, fa7, dyn<br> [0x800004ac]:csrrs a7, fflags, zero<br> [0x800004b0]:sd s7, 160(a5)<br>    |
|  12|[0x800023c0]<br>0x0000000000000000|- rd : x3<br> - rs1 : f4<br> - fs1 == 1 and fe1 == 0x7fe and fm1 == 0xfffffffffffff and rm_val == 0  #nosat<br>                           |[0x800004c0]:fcvt.lu.d gp, ft4, dyn<br> [0x800004c4]:csrrs a7, fflags, zero<br> [0x800004c8]:sd gp, 176(a5)<br>    |
|  13|[0x800023d0]<br>0xFFFFFFFFFFFFFFFF|- rd : x15<br> - rs1 : f27<br> - fs1 == 0 and fe1 == 0x7fe and fm1 == 0xfffffffffffff and rm_val == 0  #nosat<br>                         |[0x800004e4]:fcvt.lu.d a5, fs11, dyn<br> [0x800004e8]:csrrs s5, fflags, zero<br> [0x800004ec]:sd a5, 0(s3)<br>     |
|  14|[0x800023e0]<br>0x0000000000000000|- rd : x7<br> - rs1 : f30<br> - fs1 == 1 and fe1 == 0x001 and fm1 == 0x0000000000002 and rm_val == 0  #nosat<br>                          |[0x80000508]:fcvt.lu.d t2, ft10, dyn<br> [0x8000050c]:csrrs a7, fflags, zero<br> [0x80000510]:sd t2, 0(a5)<br>     |
|  15|[0x800023f0]<br>0x0000000000000000|- rd : x0<br> - rs1 : f6<br> - fs1 == 0 and fe1 == 0x001 and fm1 == 0x0000000000002 and rm_val == 0  #nosat<br>                           |[0x80000520]:fcvt.lu.d zero, ft6, dyn<br> [0x80000524]:csrrs a7, fflags, zero<br> [0x80000528]:sd zero, 16(a5)<br> |
|  16|[0x80002400]<br>0x0000000000000000|- rd : x24<br> - rs1 : f10<br> - fs1 == 1 and fe1 == 0x001 and fm1 == 0x0000000000000 and rm_val == 0  #nosat<br>                         |[0x80000538]:fcvt.lu.d s8, fa0, dyn<br> [0x8000053c]:csrrs a7, fflags, zero<br> [0x80000540]:sd s8, 32(a5)<br>     |
|  17|[0x80002410]<br>0x0000000000000000|- rd : x1<br> - rs1 : f14<br> - fs1 == 0 and fe1 == 0x001 and fm1 == 0x0000000000000 and rm_val == 0  #nosat<br>                          |[0x80000550]:fcvt.lu.d ra, fa4, dyn<br> [0x80000554]:csrrs a7, fflags, zero<br> [0x80000558]:sd ra, 48(a5)<br>     |
|  18|[0x80002420]<br>0x0000000000000000|- rd : x28<br> - rs1 : f24<br> - fs1 == 1 and fe1 == 0x000 and fm1 == 0xfffffffffffff and rm_val == 0  #nosat<br>                         |[0x80000568]:fcvt.lu.d t3, fs8, dyn<br> [0x8000056c]:csrrs a7, fflags, zero<br> [0x80000570]:sd t3, 64(a5)<br>     |
|  19|[0x80002430]<br>0x0000000000000000|- rd : x31<br> - rs1 : f5<br> - fs1 == 0 and fe1 == 0x000 and fm1 == 0xfffffffffffff and rm_val == 0  #nosat<br>                          |[0x80000580]:fcvt.lu.d t6, ft5, dyn<br> [0x80000584]:csrrs a7, fflags, zero<br> [0x80000588]:sd t6, 80(a5)<br>     |
|  20|[0x80002440]<br>0x0000000000000000|- rd : x9<br> - rs1 : f28<br> - fs1 == 1 and fe1 == 0x000 and fm1 == 0x0000000000002 and rm_val == 0  #nosat<br>                          |[0x80000598]:fcvt.lu.d s1, ft8, dyn<br> [0x8000059c]:csrrs a7, fflags, zero<br> [0x800005a0]:sd s1, 96(a5)<br>     |
|  21|[0x80002450]<br>0x0000000000000000|- rd : x18<br> - rs1 : f23<br> - fs1 == 0 and fe1 == 0x000 and fm1 == 0x0000000000002 and rm_val == 0  #nosat<br>                         |[0x800005b0]:fcvt.lu.d s2, fs7, dyn<br> [0x800005b4]:csrrs a7, fflags, zero<br> [0x800005b8]:sd s2, 112(a5)<br>    |
|  22|[0x80002460]<br>0x0000000000000000|- rd : x17<br> - rs1 : f16<br> - fs1 == 1 and fe1 == 0x000 and fm1 == 0x0000000000001 and rm_val == 0  #nosat<br>                         |[0x800005d4]:fcvt.lu.d a7, fa6, dyn<br> [0x800005d8]:csrrs s5, fflags, zero<br> [0x800005dc]:sd a7, 0(s3)<br>      |
|  23|[0x80002470]<br>0x0000000000000000|- rd : x22<br> - rs1 : f13<br> - fs1 == 0 and fe1 == 0x000 and fm1 == 0x0000000000001 and rm_val == 0  #nosat<br>                         |[0x800005f8]:fcvt.lu.d s6, fa3, dyn<br> [0x800005fc]:csrrs a7, fflags, zero<br> [0x80000600]:sd s6, 0(a5)<br>      |
|  24|[0x80002480]<br>0x0000000000000000|- rd : x25<br> - rs1 : f31<br> - fs1 == 1 and fe1 == 0x000 and fm1 == 0x0000000000000 and rm_val == 0  #nosat<br>                         |[0x80000610]:fcvt.lu.d s9, ft11, dyn<br> [0x80000614]:csrrs a7, fflags, zero<br> [0x80000618]:sd s9, 16(a5)<br>    |
|  25|[0x80002490]<br>0x0000000000000000|- rd : x16<br> - rs1 : f21<br>                                                                                                            |[0x80000634]:fcvt.lu.d a6, fs5, dyn<br> [0x80000638]:csrrs s5, fflags, zero<br> [0x8000063c]:sd a6, 0(s3)<br>      |
|  26|[0x800024a0]<br>0x0000000000000000|- rd : x13<br> - rs1 : f22<br>                                                                                                            |[0x80000658]:fcvt.lu.d a3, fs6, dyn<br> [0x8000065c]:csrrs a7, fflags, zero<br> [0x80000660]:sd a3, 0(a5)<br>      |
|  27|[0x800024b0]<br>0x0000000000000000|- rd : x27<br> - rs1 : f8<br>                                                                                                             |[0x80000670]:fcvt.lu.d s11, fs0, dyn<br> [0x80000674]:csrrs a7, fflags, zero<br> [0x80000678]:sd s11, 16(a5)<br>   |
|  28|[0x800024c0]<br>0x0000000000000000|- rd : x8<br> - rs1 : f19<br>                                                                                                             |[0x80000688]:fcvt.lu.d fp, fs3, dyn<br> [0x8000068c]:csrrs a7, fflags, zero<br> [0x80000690]:sd fp, 32(a5)<br>     |
|  29|[0x800024d0]<br>0x0000000000000000|- rd : x19<br> - rs1 : f15<br>                                                                                                            |[0x800006a0]:fcvt.lu.d s3, fa5, dyn<br> [0x800006a4]:csrrs a7, fflags, zero<br> [0x800006a8]:sd s3, 48(a5)<br>     |
|  30|[0x800024e0]<br>0x0000000000000000|- rd : x6<br> - rs1 : f12<br>                                                                                                             |[0x800006b8]:fcvt.lu.d t1, fa2, dyn<br> [0x800006bc]:csrrs a7, fflags, zero<br> [0x800006c0]:sd t1, 64(a5)<br>     |
|  31|[0x800024f0]<br>0x0000000000000000|- rd : x2<br> - rs1 : f2<br>                                                                                                              |[0x800006d0]:fcvt.lu.d sp, ft2, dyn<br> [0x800006d4]:csrrs a7, fflags, zero<br> [0x800006d8]:sd sp, 80(a5)<br>     |
|  32|[0x80002500]<br>0x0000000000000000|- rd : x20<br> - rs1 : f25<br>                                                                                                            |[0x800006e8]:fcvt.lu.d s4, fs9, dyn<br> [0x800006ec]:csrrs a7, fflags, zero<br> [0x800006f0]:sd s4, 96(a5)<br>     |
