...
|---:|----------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------|
|   1|[0x80002310]<br>0x7FFFFFFFFFFFF000|- opcode : fcvt.lu.d<br> - rd : x11<br> - rs1 : f31<br> - fs1 == 0 and fe1 == 0x43d and fm1 == 0xffffffffffffc and rm_val == 0  #nosat<br> |[0x800003b8]:fcvt.lu.d a1, ft11, dyn<br> [0x800003bc]:csrrs a7, fflags, zero<br> [0x800003c0]:sd a1, 0(a5)<br>      |
|   2|[0x80002320]<br>0x8000000000002000|- rd : x22<br> - rs1 : f15<br> - fs1 == 0 and fe1 == 0x43e and fm1 == 0x0000000000004 and rm_val == 4  #nosat<br>                          |[0x800003d0]:fcvt.lu.d s6, fa5, dyn<br> [0x800003d4]:csrrs a7, fflags, zero<br> [0x800003d8]:sd s6, 16(a5)<br>      |
|   3|[0x80002330]<br>0x8000000000002000|- rd : x5<br> - rs1 : f21<br> - fs1 == 0 and fe1 == 0x43e and fm1 == 0x0000000000004 and rm_val == 3  #nosat<br>                           |[0x800003e8]:fcvt.lu.d t0, fs5, dyn<br> [0x800003ec]:csrrs a7, fflags, zero<br> [0x800003f0]:sd t0, 32(a5)<br>      |
|   4|[0x80002340]<br>0x8000000000002000|- rd : x31<br> - rs1 : f22<br> - fs1 == 0 and fe1 == 0x43e and fm1 == 0x0000000000004 and rm_val == 2  #nosat<br>                          |[0x80000400]:fcvt.lu.d t6, fs6, dyn<br> [0x80000404]:csrrs a7, fflags, zero<br> [0x80000408]:sd t6, 48(a5)<br>      |
|   5|[0x80002350]<br>0x8000000000002000|- rd : x17<br> - rs1 : f1<br> - fs1 == 0 and fe1 == 0x43e and fm1 == 0x0000000000004 and rm_val == 1  #nosat<br>                           |[0x80000424]:fcvt.lu.d a7, ft1, dyn<br> [0x80000428]:csrrs s5, fflags, zero<br> [0x8000042c]:sd a7, 0(s3)<br>       |
|   6|[0x80002360]<br>0x8000000000002000|- rd : x24<br> - rs1 : f19<br> - fs1 == 0 and fe1 == 0x43e and fm1 == 0x0000000000004 and rm_val == 0  #nosat<br>                          |[0x80000448]:fcvt.lu.d s8, fs3, dyn<br> [0x8000044c]:csrrs a7, fflags, zero<br> [0x80000450]:sd s8, 0(a5)<br>       |
|   7|[0x80002370]<br>0x8000000000001800|- rd : x18<br> - rs1 : f13<br> - fs1 == 0 and fe1 == 0x43e and fm1 == 0x0000000000003 and rm_val == 4  #nosat<br>                          |[0x80000460]:fcvt.lu.d s2, fa3, dyn<br> [0x80000464]:csrrs a7, fflags, zero<br> [0x80000468]:sd s2, 16(a5)<br>      |
|   8|[0x80002380]<br>0x8000000000001800|- rd : x1<br> - rs1 : f26<br> - fs1 == 0 and fe1 == 0x43e and fm1 == 0x0000000000003 and rm_val == 3  #nosat<br>                           |[0x80000478]:fcvt.lu.d ra, fs10, dyn<br> [0x8000047c]:csrrs a7, fflags, zero<br> [0x80000480]:sd ra, 32(a5)<br>     |
|   9|[0x80002390]<br>0x8000000000001800|- rd : x4<br> - rs1 : f8<br> - fs1 == 0 and fe1 == 0x43e and fm1 == 0x0000000000003 and rm_val == 2  #nosat<br>                            |[0x80000490]:fcvt.lu.d tp, fs0, dyn<br> [0x80000494]:csrrs a7, fflags, zero<br> [0x80000498]:sd tp, 48(a5)<br>      |
|  10|[0x800023a0]<br>0x8000000000001800|- rd : x16<br> - rs1 : f20<br> - fs1 == 0 and fe1 == 0x43e and fm1 == 0x0000000000003 and rm_val == 1  #nosat<br>                          |[0x800004b4]:fcvt.lu.d a6, fs4, dyn<br> [0x800004b8]:csrrs s5, fflags, zero<br> [0x800004bc]:sd a6, 0(s3)<br>       |
|  11|[0x800023b0]<br>0x8000000000001800|- rd : x2<br> - rs1 : f3<br> - fs1 == 0 and fe1 == 0x43e and fm1 == 0x0000000000003 and rm_val == 0  #nosat<br>                            |[0x800004d8]:fcvt.lu.d sp, ft3, dyn<br> [0x800004dc]:csrrs a7, fflags, zero<br> [0x800004e0]:sd sp, 0(a5)<br>       |
|  12|[0x800023c0]<br>0x8000000000001000|- rd : x15<br> - rs1 : f30<br> - fs1 == 0 and fe1 == 0x43e and fm1 == 0x0000000000002 and rm_val == 4  #nosat<br>                          |[0x800004fc]:fcvt.lu.d a5, ft10, dyn<br> [0x80000500]:csrrs s5, fflags, zero<br> [0x80000504]:sd a5, 0(s3)<br>      |
|  13|[0x800023d0]<br>0x8000000000001000|- rd : x9<br> - rs1 : f12<br> - fs1 == 0 and fe1 == 0x43e and fm1 == 0x0000000000002 and rm_val == 3  #nosat<br>                           |[0x80000520]:fcvt.lu.d s1, fa2, dyn<br> [0x80000524]:csrrs a7, fflags, zero<br> [0x80000528]:sd s1, 0(a5)<br>       |
|  14|[0x800023e0]<br>0x8000000000001000|- rd : x28<br> - rs1 : f7<br> - fs1 == 0 and fe1 == 0x43e and fm1 == 0x0000000000002 and rm_val == 2  #nosat<br>                           |[0x80000538]:fcvt.lu.d t3, ft7, dyn<br> [0x8000053c]:csrrs a7, fflags, zero<br> [0x80000540]:sd t3, 16(a5)<br>      |
|  15|[0x800023f0]<br>0x8000000000001000|- rd : x10<br> - rs1 : f28<br> - fs1 == 0 and fe1 == 0x43e and fm1 == 0x0000000000002 and rm_val == 1  #nosat<br>                          |[0x80000550]:fcvt.lu.d a0, ft8, dyn<br> [0x80000554]:csrrs a7, fflags, zero<br> [0x80000558]:sd a0, 32(a5)<br>      |
|  16|[0x80002400]<br>0x8000000000001000|- rd : x7<br> - rs1 : f23<br> - fs1 == 0 and fe1 == 0x43e and fm1 == 0x0000000000002 and rm_val == 0  #nosat<br>                           |[0x80000568]:fcvt.lu.d t2, fs7, dyn<br> [0x8000056c]:csrrs a7, fflags, zero<br> [0x80000570]:sd t2, 48(a5)<br>      |
|  17|[0x80002410]<br>0x0000000000000000|- rd : x0<br> - rs1 : f27<br> - fs1 == 0 and fe1 == 0x43e and fm1 == 0x0000000000001 and rm_val == 4  #nosat<br>                           |[0x80000580]:fcvt.lu.d zero, fs11, dyn<br> [0x80000584]:csrrs a7, fflags, zero<br> [0x80000588]:sd zero, 64(a5)<br> |
|  18|[0x80002420]<br>0x8000000000000800|- rd : x14<br> - rs1 : f0<br> - fs1 == 0 and fe1 == 0x43e and fm1 == 0x0000000000001 and rm_val == 3  #nosat<br>                           |[0x80000598]:fcvt.lu.d a4, ft0, dyn<br> [0x8000059c]:csrrs a7, fflags, zero<br> [0x800005a0]:sd a4, 80(a5)<br>      |
|  19|[0x80002430]<br>0x8000000000000800|- rd : x20<br> - rs1 : f10<br> - fs1 == 0 and fe1 == 0x43e and fm1 == 0x0000000000001 and rm_val == 2  #nosat<br>                          |[0x800005b0]:fcvt.lu.d s4, fa0, dyn<br> [0x800005b4]:csrrs a7, fflags, zero<br> [0x800005b8]:sd s4, 96(a5)<br>      |
|  20|[0x80002440]<br>0x8000000000000800|- rd : x23<br> - rs1 : f9<br> - fs1 == 0 and fe1 == 0x43e and fm1 == 0x0000000000001 and rm_val == 1  #nosat<br>                           |[0x800005c8]:fcvt.lu.d s7, fs1, dyn<br> [0x800005cc]:csrrs a7, fflags, zero<br> [0x800005d0]:sd s7, 112(a5)<br>     |
|  21|[0x80002450]<br>0x8000000000000800|- rd : x29<br> - rs1 : f2<br> - fs1 == 0 and fe1 == 0x43e and fm1 == 0x0000000000001 and rm_val == 0  #nosat<br>                           |[0x800005e0]:fcvt.lu.d t4, ft2, dyn<br> [0x800005e4]:csrrs a7, fflags, zero<br> [0x800005e8]:sd t4, 128(a5)<br>     |
|  22|[0x80002460]<br>0x8000000000000000|- rd : x3<br> - rs1 : f14<br> - fs1 == 0 and fe1 == 0x43e and fm1 == 0x0000000000000 and rm_val == 4  #nosat<br>                           |[0x800005f8]:fcvt.lu.d gp, fa4, dyn<br> [0x800005fc]:csrrs a7, fflags, zero<br> [0x80000600]:sd gp, 144(a5)<br>     |
|  23|[0x80002470]<br>0x8000000000000000|- rd : x6<br> - rs1 : f29<br> - fs1 == 0 and fe1 == 0x43e and fm1 == 0x0000000000000 and rm_val == 3  #nosat<br>                           |[0x80000610]:fcvt.lu.d t1, ft9, dyn<br> [0x80000614]:csrrs a7, fflags, zero<br> [0x80000618]:sd t1, 160(a5)<br>     |
|  24|[0x80002480]<br>0x8000000000000000|- rd : x12<br> - rs1 : f5<br> - fs1 == 0 and fe1 == 0x43e and fm1 == 0x0000000000000 and rm_val == 2  #nosat<br>                           |[0x80000628]:fcvt.lu.d a2, ft5, dyn<br> [0x8000062c]:csrrs a7, fflags, zero<br> [0x80000630]:sd a2, 176(a5)<br>     |
|  25|[0x80002490]<br>0x8000000000000000|- rd : x27<br> - rs1 : f11<br> - fs1 == 0 and fe1 == 0x43e and fm1 == 0x0000000000000 and rm_val == 1  #nosat<br>                          |[0x80000640]:fcvt.lu.d s11, fa1, dyn<br> [0x80000644]:csrrs a7, fflags, zero<br> [0x80000648]:sd s11, 192(a5)<br>   |
|  26|[0x800024a0]<br>0x8000000000000000|- rd : x30<br> - rs1 : f6<br> - fs1 == 0 and fe1 == 0x43e and fm1 == 0x0000000000000 and rm_val == 0  #nosat<br>                           |[0x80000658]:fcvt.lu.d t5, ft6, dyn<br> [0x8000065c]:csrrs a7, fflags, zero<br> [0x80000660]:sd t5, 208(a5)<br>     |
|  27|[0x800024b0]<br>0x7FFFFFFFFFFFFC00|- rd : x8<br> - rs1 : f24<br> - fs1 == 0 and fe1 == 0x43d and fm1 == 0xfffffffffffff and rm_val == 4  #nosat<br>                           |[0x80000670]:fcvt.lu.d fp, fs8, dyn<br> [0x80000674]:csrrs a7, fflags, zero<br> [0x80000678]:sd fp, 224(a5)<br>     |
|  28|[0x800024c0]<br>0x7FFFFFFFFFFFFC00|- rd : x25<br> - rs1 : f17<br> - fs1 == 0 and fe1 == 0x43d and fm1 == 0xfffffffffffff and rm_val == 3  #nosat<br>                          |[0x80000688]:fcvt.lu.d s9, fa7, dyn<br> [0x8000068c]:csrrs a7, fflags, zero<br> [0x80000690]:sd s9, 240(a5)<br>     |
|  29|[0x800024d0]<br>0x7FFFFFFFFFFFFC00|- rd : x21<br> - rs1 : f18<br> - fs1 == 0 and fe1 == 0x43d and fm1 == 0xfffffffffffff and rm_val == 2  #nosat<br>                          |[0x800006a0]:fcvt.lu.d s5, fs2, dyn<br> [0x800006a4]:csrrs a7, fflags, zero<br> [0x800006a8]:sd s5, 256(a5)<br>     |
|  30|[0x800024e0]<br>0x7FFFFFFFFFFFFC00|- rd : x19<br> - rs1 : f16<br> - fs1 == 0 and fe1 == 0x43d and fm1 == 0xfffffffffffff and rm_val == 1  #nosat<br>                          |[0x800006b8]:fcvt.lu.d s3, fa6, dyn<br> [0x800006bc]:csrrs a7, fflags, zero<br> [0x800006c0]:sd s3, 272(a5)<br>     |
|  31|[0x800024f0]<br>0x7FFFFFFFFFFFFC00|- rd : x26<br> - rs1 : f25<br> - fs1 == 0 and fe1 == 0x43d and fm1 == 0xfffffffffffff and rm_val == 0  #nosat<br>                          |[0x800006d0]:fcvt.lu.d s10, fs9, dyn<br> [0x800006d4]:csrrs a7, fflags, zero<br> [0x800006d8]:sd s10, 288(a5)<br>   |
|  32|[0x80002500]<br>0x7FFFFFFFFFFFF800|- rd : x13<br> - rs1 : f4<br> - fs1 == 0 and fe1 == 0x43d and fm1 == 0xffffffffffffe and rm_val == 4  #nosat<br>                           |[0x800006e8]:fcvt.lu.d a3, ft4, dyn<br> [0x800006ec]:csrrs a7, fflags, zero<br> [0x800006f0]:sd a3, 304(a5)<br>     |
|  33|[0x80002510]<br>0x7FFFFFFFFFFFF800|- fs1 == 0 and fe1 == 0x43d and fm1 == 0xffffffffffffe and rm_val == 3  #nosat<br>                                                         |[0x80000700]:fcvt.lu.d a1, fa0, dyn<br> [0x80000704]:csrrs a7, fflags, zero<br> [0x80000708]:sd a1, 320(a5)<br>     |
|  34|[0x80002520]<br>0x7FFFFFFFFFFFF800|- fs1 == 0 and fe1 == 0x43d and fm1 == 0xffffffffffffe and rm_val == 2  #nosat<br>                                                         |[0x80000718]:fcvt.lu.d a1, fa0, dyn<br> [0x8000071c]:csrrs a7, fflags, zero<br> [0x80000720]:sd a1, 336(a5)<br>     |
|  35|[0x80002530]<br>0x7FFFFFFFFFFFF800|- fs1 == 0 and fe1 == 0x43d and fm1 == 0xffffffffffffe and rm_val == 1  #nosat<br>                                                         |[0x80000730]:fcvt.lu.d a1, fa0, dyn<br> [0x80000734]:csrrs a7, fflags, zero<br> [0x80000738]:sd a1, 352(a5)<br>     |
|  36|[0x80002540]<br>0x7FFFFFFFFFFFF800|- fs1 == 0 and fe1 == 0x43d and fm1 == 0xffffffffffffe and rm_val == 0  #nosat<br>                                                         |[0x80000748]:fcvt.lu.d a1, fa0, dyn<br> [0x8000074c]:csrrs a7, fflags, zero<br> [0x80000750]:sd a1, 368(a5)<br>     |
