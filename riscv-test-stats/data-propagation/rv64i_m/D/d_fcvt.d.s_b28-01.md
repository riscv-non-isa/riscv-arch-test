...
|---:|----------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------|
|   1|[0x80002310]<br>0xDF56FF76DF56FF76|- opcode : fcvt.d.s<br> - rs1 : f26<br> - rd : f18<br> - rs1 != rd<br> - fs1 == 0 and fe1 == 0x000 and fm1 == 0x0000000000000 and rm_val == 0  #nosat<br> |[0x800003b8]:fcvt.d.s fs2, fs10, rne<br> [0x800003bc]:csrrs a7, fflags, zero<br> [0x800003c0]:fsd fs2, 0(a5)<br>    |
|   2|[0x80002320]<br>0xEEDBEADFEEDBEADF|- rs1 : f29<br> - rd : f29<br> - rs1 == rd<br> - fs1 == 1 and fe1 == 0x7ff and fm1 == 0x0000000000000 and rm_val == 0  #nosat<br>                         |[0x800003d0]:fcvt.d.s ft9, ft9, rne<br> [0x800003d4]:csrrs a7, fflags, zero<br> [0x800003d8]:fsd ft9, 16(a5)<br>    |
|   3|[0x80002330]<br>0xB7FBB6FAB7FBB6FA|- rs1 : f17<br> - rd : f7<br> - fs1 == 1 and fe1 == 0x43e and fm1 == 0x0000000000000 and rm_val == 0  #nosat<br>                                          |[0x800003e8]:fcvt.d.s ft7, fa7, rne<br> [0x800003ec]:csrrs a7, fflags, zero<br> [0x800003f0]:fsd ft7, 32(a5)<br>    |
|   4|[0x80002340]<br>0xEDBEADFEEDBEADFE|- rs1 : f13<br> - rd : f25<br> - fs1 == 1 and fe1 == 0x43d and fm1 == 0x967a4ae26514c and rm_val == 0  #nosat<br>                                         |[0x80000400]:fcvt.d.s fs9, fa3, rne<br> [0x80000404]:csrrs a7, fflags, zero<br> [0x80000408]:fsd fs9, 48(a5)<br>    |
|   5|[0x80002350]<br>0xF76DF56FF76DF56F|- rs1 : f3<br> - rd : f30<br> - fs1 == 1 and fe1 == 0x3ff and fm1 == 0x4000000000000 and rm_val == 0  #nosat<br>                                          |[0x80000418]:fcvt.d.s ft10, ft3, rne<br> [0x8000041c]:csrrs a7, fflags, zero<br> [0x80000420]:fsd ft10, 64(a5)<br>  |
|   6|[0x80002360]<br>0xDBEADFEEDBEADFEE|- rs1 : f2<br> - rd : f21<br> - fs1 == 1 and fe1 == 0x3ff and fm1 == 0x8000000000000 and rm_val == 0  #nosat<br>                                          |[0x80000430]:fcvt.d.s fs5, ft2, rne<br> [0x80000434]:csrrs a7, fflags, zero<br> [0x80000438]:fsd fs5, 80(a5)<br>    |
|   7|[0x80002370]<br>0xB7D5BFDDB7D5BFDD|- rs1 : f1<br> - rd : f20<br> - fs1 == 1 and fe1 == 0x3ff and fm1 == 0xc000000000000 and rm_val == 0  #nosat<br>                                          |[0x80000448]:fcvt.d.s fs4, ft1, rne<br> [0x8000044c]:csrrs a7, fflags, zero<br> [0x80000450]:fsd fs4, 96(a5)<br>    |
|   8|[0x80002380]<br>0x0000000080002310|- rs1 : f23<br> - rd : f15<br> - fs1 == 1 and fe1 == 0x400 and fm1 == 0x0000000000000 and rm_val == 0  #nosat<br>                                         |[0x80000460]:fcvt.d.s fa5, fs7, rne<br> [0x80000464]:csrrs a7, fflags, zero<br> [0x80000468]:fsd fa5, 112(a5)<br>   |
|   9|[0x80002390]<br>0x0000000080000390|- rs1 : f25<br> - rd : f5<br> - fs1 == 1 and fe1 == 0x400 and fm1 == 0x2000000000000 and rm_val == 0  #nosat<br>                                          |[0x80000478]:fcvt.d.s ft5, fs9, rne<br> [0x8000047c]:csrrs a7, fflags, zero<br> [0x80000480]:fsd ft5, 128(a5)<br>   |
|  10|[0x800023a0]<br>0xAB7FBB6FAB7FBB6F|- rs1 : f31<br> - rd : f11<br> - fs1 == 1 and fe1 == 0x400 and fm1 == 0x4000000000000 and rm_val == 0  #nosat<br>                                         |[0x80000490]:fcvt.d.s fa1, ft11, rne<br> [0x80000494]:csrrs a7, fflags, zero<br> [0x80000498]:fsd fa1, 144(a5)<br>  |
|  11|[0x800023b0]<br>0xDDB7D5BFDDB7D5BF|- rs1 : f10<br> - rd : f28<br> - fs1 == 1 and fe1 == 0x400 and fm1 == 0x6000000000000 and rm_val == 0  #nosat<br>                                         |[0x800004a8]:fcvt.d.s ft8, fa0, rne<br> [0x800004ac]:csrrs a7, fflags, zero<br> [0x800004b0]:fsd ft8, 160(a5)<br>   |
|  12|[0x800023c0]<br>0xF56FF76DF56FF76D|- rs1 : f20<br> - rd : f14<br> - fs1 == 1 and fe1 == 0x3f8 and fm1 == 0x0000000000000 and rm_val == 0  #nosat<br>                                         |[0x800004c0]:fcvt.d.s fa4, fs4, rne<br> [0x800004c4]:csrrs a7, fflags, zero<br> [0x800004c8]:fsd fa4, 176(a5)<br>   |
|  13|[0x800023d0]<br>0x0000000080002000|- rs1 : f27<br> - rd : f6<br> - fs1 == 1 and fe1 == 0x3fd and fm1 == 0xb008d57e19f88 and rm_val == 0  #nosat<br>                                          |[0x800004d8]:fcvt.d.s ft6, fs11, rne<br> [0x800004dc]:csrrs a7, fflags, zero<br> [0x800004e0]:fsd ft6, 192(a5)<br>  |
|  14|[0x800023e0]<br>0xDB7D5BFDDB7D5BFD|- rs1 : f28<br> - rd : f24<br> - fs1 == 1 and fe1 == 0x000 and fm1 == 0x0000000000000 and rm_val == 0  #nosat<br>                                         |[0x800004f0]:fcvt.d.s fs8, ft8, rne<br> [0x800004f4]:csrrs a7, fflags, zero<br> [0x800004f8]:fsd fs8, 208(a5)<br>   |
|  15|[0x800023f0]<br>0x76DF56FF76DF56FF|- rs1 : f5<br> - rd : f26<br> - fs1 == 0 and fe1 == 0x7ff and fm1 == 0x8000000000001 and rm_val == 0  #nosat<br>                                          |[0x80000508]:fcvt.d.s fs10, ft5, rne<br> [0x8000050c]:csrrs a7, fflags, zero<br> [0x80000510]:fsd fs10, 224(a5)<br> |
|  16|[0x80002400]<br>0xFBB6FAB7FBB6FAB7|- rs1 : f12<br> - rd : f31<br> - fs1 == 0 and fe1 == 0x7ff and fm1 == 0x0000000000001 and rm_val == 0  #nosat<br>                                         |[0x80000520]:fcvt.d.s ft11, fa2, rne<br> [0x80000524]:csrrs a7, fflags, zero<br> [0x80000528]:fsd ft11, 240(a5)<br> |
|  17|[0x80002410]<br>0xFEEDBEADFEEDBEAD|- rs1 : f4<br> - rd : f1<br> - fs1 == 0 and fe1 == 0x7ff and fm1 == 0x0000000000000 and rm_val == 0  #nosat<br>                                           |[0x80000538]:fcvt.d.s ft1, ft4, rne<br> [0x8000053c]:csrrs a7, fflags, zero<br> [0x80000540]:fsd ft1, 256(a5)<br>   |
|  18|[0x80002420]<br>0x6DF56FF76DF56FF7|- rs1 : f8<br> - rd : f22<br> - fs1 == 0 and fe1 == 0x43e and fm1 == 0x0000000000000 and rm_val == 0  #nosat<br>                                          |[0x80000550]:fcvt.d.s fs6, fs0, rne<br> [0x80000554]:csrrs a7, fflags, zero<br> [0x80000558]:fsd fs6, 272(a5)<br>   |
|  19|[0x80002430]<br>0xB6FAB7FBB6FAB7FB|- rs1 : f21<br> - rd : f23<br> - fs1 == 0 and fe1 == 0x43c and fm1 == 0xb72eb13dc494a and rm_val == 0  #nosat<br>                                         |[0x80000568]:fcvt.d.s fs7, fs5, rne<br> [0x8000056c]:csrrs a7, fflags, zero<br> [0x80000570]:fsd fs7, 288(a5)<br>   |
|  20|[0x80002440]<br>0x6FAB7FBB6FAB7FBB|- rs1 : f15<br> - rd : f19<br> - fs1 == 0 and fe1 == 0x400 and fm1 == 0x6000000000000 and rm_val == 0  #nosat<br>                                         |[0x80000580]:fcvt.d.s fs3, fa5, rne<br> [0x80000584]:csrrs a7, fflags, zero<br> [0x80000588]:fsd fs3, 304(a5)<br>   |
|  21|[0x80002450]<br>0x0000000A00006000|- rs1 : f14<br> - rd : f2<br> - fs1 == 0 and fe1 == 0x400 and fm1 == 0x4000000000000 and rm_val == 0  #nosat<br>                                          |[0x80000598]:fcvt.d.s ft2, fa4, rne<br> [0x8000059c]:csrrs a7, fflags, zero<br> [0x800005a0]:fsd ft2, 320(a5)<br>   |
|  22|[0x80002460]<br>0xBFDDB7D5BFDDB7D5|- rs1 : f7<br> - rd : f4<br> - fs1 == 0 and fe1 == 0x400 and fm1 == 0x2000000000000 and rm_val == 0  #nosat<br>                                           |[0x800005b0]:fcvt.d.s ft4, ft7, rne<br> [0x800005b4]:csrrs a7, fflags, zero<br> [0x800005b8]:fsd ft4, 336(a5)<br>   |
|  23|[0x80002470]<br>0x0000000000000000|- rs1 : f6<br> - rd : f0<br> - fs1 == 0 and fe1 == 0x400 and fm1 == 0x0000000000000 and rm_val == 0  #nosat<br>                                           |[0x800005c8]:fcvt.d.s ft0, ft6, rne<br> [0x800005cc]:csrrs a7, fflags, zero<br> [0x800005d0]:fsd ft0, 352(a5)<br>   |
|  24|[0x80002480]<br>0x5BFDDB7D5BFDDB7D|- rs1 : f30<br> - rd : f8<br> - fs1 == 0 and fe1 == 0x3ff and fm1 == 0xc000000000000 and rm_val == 0  #nosat<br>                                          |[0x800005e0]:fcvt.d.s fs0, ft10, rne<br> [0x800005e4]:csrrs a7, fflags, zero<br> [0x800005e8]:fsd fs0, 368(a5)<br>  |
|  25|[0x80002490]<br>0x56FF76DF56FF76DF|- rs1 : f19<br> - rd : f10<br> - fs1 == 0 and fe1 == 0x3ff and fm1 == 0x8000000000000 and rm_val == 0  #nosat<br>                                         |[0x800005f8]:fcvt.d.s fa0, fs3, rne<br> [0x800005fc]:csrrs a7, fflags, zero<br> [0x80000600]:fsd fa0, 384(a5)<br>   |
|  26|[0x800024a0]<br>0x0000000A00000000|- rs1 : f18<br> - rd : f3<br> - fs1 == 0 and fe1 == 0x3ff and fm1 == 0x4000000000000 and rm_val == 0  #nosat<br>                                          |[0x80000610]:fcvt.d.s ft3, fs2, rne<br> [0x80000614]:csrrs a7, fflags, zero<br> [0x80000618]:fsd ft3, 400(a5)<br>   |
|  27|[0x800024b0]<br>0x0000000000000000|- rs1 : f11<br> - rd : f17<br> - fs1 == 0 and fe1 == 0x3ff and fm1 == 0x0000000000000 and rm_val == 0  #nosat<br>                                         |[0x80000628]:fcvt.d.s fa7, fa1, rne<br> [0x8000062c]:csrrs a7, fflags, zero<br> [0x80000630]:fsd fa7, 416(a5)<br>   |
|  28|[0x800024c0]<br>0x0000000080002010|- rs1 : f0<br> - rd : f16<br> - fs1 == 0 and fe1 == 0x3fe and fm1 == 0x248ee18215dfa and rm_val == 0  #nosat<br>                                          |[0x80000640]:fcvt.d.s fa6, ft0, rne<br> [0x80000644]:csrrs a7, fflags, zero<br> [0x80000648]:fsd fa6, 432(a5)<br>   |
|  29|[0x800024d0]<br>0xADFEEDBEADFEEDBE|- rs1 : f22<br> - rd : f9<br>                                                                                                                             |[0x80000658]:fcvt.d.s fs1, fs6, rne<br> [0x8000065c]:csrrs a7, fflags, zero<br> [0x80000660]:fsd fs1, 448(a5)<br>   |
|  30|[0x800024e0]<br>0xD5BFDDB7D5BFDDB7|- rs1 : f16<br> - rd : f12<br>                                                                                                                            |[0x80000670]:fcvt.d.s fa2, fa6, rne<br> [0x80000674]:csrrs a7, fflags, zero<br> [0x80000678]:fsd fa2, 464(a5)<br>   |
|  31|[0x800024f0]<br>0xBB6FAB7FBB6FAB7F|- rs1 : f9<br> - rd : f27<br>                                                                                                                             |[0x80000688]:fcvt.d.s fs11, fs1, rne<br> [0x8000068c]:csrrs a7, fflags, zero<br> [0x80000690]:fsd fs11, 480(a5)<br> |
|  32|[0x80002500]<br>0xEADFEEDBEADFEEDB|- rs1 : f24<br> - rd : f13<br>                                                                                                                            |[0x800006a0]:fcvt.d.s fa3, fs8, rne<br> [0x800006a4]:csrrs a7, fflags, zero<br> [0x800006a8]:fsd fa3, 496(a5)<br>   |
