...
|---:|----------------------------------|----------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|
|   1|[0x80002210]<br>0x0000000000000000|- opcode : fcvt.wu.s<br> - rd : x18<br> - rs1 : f8<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x000000 and rm_val == 0  #nosat<br> |[0x800001d0]:fcvt.wu.s s2, fs0, dyn<br> [0x800001d4]:csrrs a7, fflags, zero<br> [0x800001d8]:sw s2, 0(a5)<br>      |
|   2|[0x80002220]<br>0x0000000000000000|- rd : x14<br> - rs1 : f28<br> - fs1 == 1 and fe1 == 0x7f and fm1 == 0x000000 and rm_val == 0  #nosat<br>                         |[0x800001e8]:fcvt.wu.s a4, ft8, dyn<br> [0x800001ec]:csrrs a7, fflags, zero<br> [0x800001f0]:sw a4, 16(a5)<br>     |
|   3|[0x80002230]<br>0x0000000000000001|- rd : x10<br> - rs1 : f19<br> - fs1 == 0 and fe1 == 0x7f and fm1 == 0x000000 and rm_val == 0  #nosat<br>                         |[0x80000200]:fcvt.wu.s a0, fs3, dyn<br> [0x80000204]:csrrs a7, fflags, zero<br> [0x80000208]:sw a0, 32(a5)<br>     |
|   4|[0x80002240]<br>0xFFFFFFFFFFFFFFFF|- rd : x28<br> - rs1 : f30<br> - fs1 == 1 and fe1 == 0xff and fm1 == 0x2aaaaa and rm_val == 0  #nosat<br>                         |[0x80000218]:fcvt.wu.s t3, ft10, dyn<br> [0x8000021c]:csrrs a7, fflags, zero<br> [0x80000220]:sw t3, 48(a5)<br>    |
|   5|[0x80002250]<br>0xFFFFFFFFFFFFFFFF|- rd : x16<br> - rs1 : f7<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x000001 and rm_val == 0  #nosat<br>                          |[0x8000023c]:fcvt.wu.s a6, ft7, dyn<br> [0x80000240]:csrrs s5, fflags, zero<br> [0x80000244]:sw a6, 0(s3)<br>      |
|   6|[0x80002260]<br>0xFFFFFFFFFFFFFFFF|- rd : x20<br> - rs1 : f5<br> - fs1 == 1 and fe1 == 0xff and fm1 == 0x455555 and rm_val == 0  #nosat<br>                          |[0x80000260]:fcvt.wu.s s4, ft5, dyn<br> [0x80000264]:csrrs a7, fflags, zero<br> [0x80000268]:sw s4, 0(a5)<br>      |
|   7|[0x80002270]<br>0xFFFFFFFFFFFFFFFF|- rd : x2<br> - rs1 : f0<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x400001 and rm_val == 0  #nosat<br>                           |[0x80000278]:fcvt.wu.s sp, ft0, dyn<br> [0x8000027c]:csrrs a7, fflags, zero<br> [0x80000280]:sw sp, 16(a5)<br>     |
|   8|[0x80002280]<br>0xFFFFFFFFFFFFFFFF|- rd : x3<br> - rs1 : f22<br> - fs1 == 1 and fe1 == 0xff and fm1 == 0x400000 and rm_val == 0  #nosat<br>                          |[0x80000290]:fcvt.wu.s gp, fs6, dyn<br> [0x80000294]:csrrs a7, fflags, zero<br> [0x80000298]:sw gp, 32(a5)<br>     |
|   9|[0x80002290]<br>0xFFFFFFFFFFFFFFFF|- rd : x4<br> - rs1 : f27<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x400000 and rm_val == 0  #nosat<br>                          |[0x800002a8]:fcvt.wu.s tp, fs11, dyn<br> [0x800002ac]:csrrs a7, fflags, zero<br> [0x800002b0]:sw tp, 48(a5)<br>    |
|  10|[0x800022a0]<br>0x0000000000000000|- rd : x7<br> - rs1 : f9<br> - fs1 == 1 and fe1 == 0xff and fm1 == 0x000000 and rm_val == 0  #nosat<br>                           |[0x800002c0]:fcvt.wu.s t2, fs1, dyn<br> [0x800002c4]:csrrs a7, fflags, zero<br> [0x800002c8]:sw t2, 64(a5)<br>     |
|  11|[0x800022b0]<br>0xFFFFFFFFFFFFFFFF|- rd : x5<br> - rs1 : f14<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x000000 and rm_val == 0  #nosat<br>                          |[0x800002d8]:fcvt.wu.s t0, fa4, dyn<br> [0x800002dc]:csrrs a7, fflags, zero<br> [0x800002e0]:sw t0, 80(a5)<br>     |
|  12|[0x800022c0]<br>0x0000000000000000|- rd : x19<br> - rs1 : f16<br> - fs1 == 1 and fe1 == 0xfe and fm1 == 0x7fffff and rm_val == 0  #nosat<br>                         |[0x800002f0]:fcvt.wu.s s3, fa6, dyn<br> [0x800002f4]:csrrs a7, fflags, zero<br> [0x800002f8]:sw s3, 96(a5)<br>     |
|  13|[0x800022d0]<br>0xFFFFFFFFFFFFFFFF|- rd : x24<br> - rs1 : f2<br> - fs1 == 0 and fe1 == 0xfe and fm1 == 0x7fffff and rm_val == 0  #nosat<br>                          |[0x80000308]:fcvt.wu.s s8, ft2, dyn<br> [0x8000030c]:csrrs a7, fflags, zero<br> [0x80000310]:sw s8, 112(a5)<br>    |
|  14|[0x800022e0]<br>0x0000000000000000|- rd : x8<br> - rs1 : f15<br> - fs1 == 1 and fe1 == 0x01 and fm1 == 0x055555 and rm_val == 0  #nosat<br>                          |[0x80000320]:fcvt.wu.s fp, fa5, dyn<br> [0x80000324]:csrrs a7, fflags, zero<br> [0x80000328]:sw fp, 128(a5)<br>    |
|  15|[0x800022f0]<br>0x0000000000000000|- rd : x27<br> - rs1 : f11<br> - fs1 == 0 and fe1 == 0x01 and fm1 == 0x000001 and rm_val == 0  #nosat<br>                         |[0x80000338]:fcvt.wu.s s11, fa1, dyn<br> [0x8000033c]:csrrs a7, fflags, zero<br> [0x80000340]:sw s11, 144(a5)<br>  |
|  16|[0x80002300]<br>0x0000000000000000|- rd : x17<br> - rs1 : f17<br> - fs1 == 1 and fe1 == 0x01 and fm1 == 0x000000 and rm_val == 0  #nosat<br>                         |[0x8000035c]:fcvt.wu.s a7, fa7, dyn<br> [0x80000360]:csrrs s5, fflags, zero<br> [0x80000364]:sw a7, 0(s3)<br>      |
|  17|[0x80002310]<br>0x0000000000000000|- rd : x30<br> - rs1 : f13<br> - fs1 == 0 and fe1 == 0x01 and fm1 == 0x000000 and rm_val == 0  #nosat<br>                         |[0x80000380]:fcvt.wu.s t5, fa3, dyn<br> [0x80000384]:csrrs a7, fflags, zero<br> [0x80000388]:sw t5, 0(a5)<br>      |
|  18|[0x80002320]<br>0x0000000000000000|- rd : x1<br> - rs1 : f6<br> - fs1 == 1 and fe1 == 0x00 and fm1 == 0x7fffff and rm_val == 0  #nosat<br>                           |[0x80000398]:fcvt.wu.s ra, ft6, dyn<br> [0x8000039c]:csrrs a7, fflags, zero<br> [0x800003a0]:sw ra, 16(a5)<br>     |
|  19|[0x80002330]<br>0x0000000000000000|- rd : x11<br> - rs1 : f25<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x7fffff and rm_val == 0  #nosat<br>                         |[0x800003b0]:fcvt.wu.s a1, fs9, dyn<br> [0x800003b4]:csrrs a7, fflags, zero<br> [0x800003b8]:sw a1, 32(a5)<br>     |
|  20|[0x80002340]<br>0x0000000000000000|- rd : x9<br> - rs1 : f29<br> - fs1 == 1 and fe1 == 0x00 and fm1 == 0x7ffffe and rm_val == 0  #nosat<br>                          |[0x800003c8]:fcvt.wu.s s1, ft9, dyn<br> [0x800003cc]:csrrs a7, fflags, zero<br> [0x800003d0]:sw s1, 48(a5)<br>     |
|  21|[0x80002350]<br>0x0000000000000000|- rd : x0<br> - rs1 : f10<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x000002 and rm_val == 0  #nosat<br>                          |[0x800003e0]:fcvt.wu.s zero, fa0, dyn<br> [0x800003e4]:csrrs a7, fflags, zero<br> [0x800003e8]:sw zero, 64(a5)<br> |
|  22|[0x80002360]<br>0x0000000000000000|- rd : x12<br> - rs1 : f24<br> - fs1 == 1 and fe1 == 0x00 and fm1 == 0x000001 and rm_val == 0  #nosat<br>                         |[0x800003f8]:fcvt.wu.s a2, fs8, dyn<br> [0x800003fc]:csrrs a7, fflags, zero<br> [0x80000400]:sw a2, 80(a5)<br>     |
|  23|[0x80002370]<br>0x0000000000000000|- rd : x31<br> - rs1 : f21<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x000001 and rm_val == 0  #nosat<br>                         |[0x80000410]:fcvt.wu.s t6, fs5, dyn<br> [0x80000414]:csrrs a7, fflags, zero<br> [0x80000418]:sw t6, 96(a5)<br>     |
|  24|[0x80002380]<br>0x0000000000000000|- rd : x23<br> - rs1 : f1<br> - fs1 == 1 and fe1 == 0x00 and fm1 == 0x000000 and rm_val == 0  #nosat<br>                          |[0x80000428]:fcvt.wu.s s7, ft1, dyn<br> [0x8000042c]:csrrs a7, fflags, zero<br> [0x80000430]:sw s7, 112(a5)<br>    |
|  25|[0x80002390]<br>0x0000000000000000|- rd : x15<br> - rs1 : f18<br>                                                                                                    |[0x8000044c]:fcvt.wu.s a5, fs2, dyn<br> [0x80000450]:csrrs s5, fflags, zero<br> [0x80000454]:sw a5, 0(s3)<br>      |
|  26|[0x800023a0]<br>0x0000000000000000|- rd : x6<br> - rs1 : f12<br>                                                                                                     |[0x80000470]:fcvt.wu.s t1, fa2, dyn<br> [0x80000474]:csrrs a7, fflags, zero<br> [0x80000478]:sw t1, 0(a5)<br>      |
|  27|[0x800023b0]<br>0x0000000000000000|- rd : x21<br> - rs1 : f23<br>                                                                                                    |[0x80000488]:fcvt.wu.s s5, fs7, dyn<br> [0x8000048c]:csrrs a7, fflags, zero<br> [0x80000490]:sw s5, 16(a5)<br>     |
|  28|[0x800023c0]<br>0x0000000000000000|- rd : x29<br> - rs1 : f31<br>                                                                                                    |[0x800004a0]:fcvt.wu.s t4, ft11, dyn<br> [0x800004a4]:csrrs a7, fflags, zero<br> [0x800004a8]:sw t4, 32(a5)<br>    |
|  29|[0x800023d0]<br>0x0000000000000000|- rd : x26<br> - rs1 : f3<br>                                                                                                     |[0x800004b8]:fcvt.wu.s s10, ft3, dyn<br> [0x800004bc]:csrrs a7, fflags, zero<br> [0x800004c0]:sw s10, 48(a5)<br>   |
|  30|[0x800023e0]<br>0x0000000000000000|- rd : x13<br> - rs1 : f4<br>                                                                                                     |[0x800004d0]:fcvt.wu.s a3, ft4, dyn<br> [0x800004d4]:csrrs a7, fflags, zero<br> [0x800004d8]:sw a3, 64(a5)<br>     |
|  31|[0x800023f0]<br>0x0000000000000000|- rd : x25<br> - rs1 : f20<br>                                                                                                    |[0x800004e8]:fcvt.wu.s s9, fs4, dyn<br> [0x800004ec]:csrrs a7, fflags, zero<br> [0x800004f0]:sw s9, 80(a5)<br>     |
|  32|[0x80002400]<br>0x0000000000000000|- rd : x22<br> - rs1 : f26<br>                                                                                                    |[0x80000500]:fcvt.wu.s s6, fs10, dyn<br> [0x80000504]:csrrs a7, fflags, zero<br> [0x80000508]:sw s6, 96(a5)<br>    |
