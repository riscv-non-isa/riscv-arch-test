...
|---:|----------------------------------|--------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------|
|   1|[0x80002210]<br>0x0000000000000000|- opcode : fcvt.w.s<br> - rd : x0<br> - rs1 : f9<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x000000 and rm_val == 0  #nosat<br> |[0x800001d0]:fcvt.w.s zero, fs1, dyn<br> [0x800001d4]:csrrs a7, fflags, zero<br> [0x800001d8]:sw zero, 0(a5)<br>  |
|   2|[0x80002220]<br>0xFFFFFFFF80000000|- rd : x18<br> - rs1 : f10<br> - fs1 == 1 and fe1 == 0xff and fm1 == 0x000000 and rm_val == 0  #nosat<br>                       |[0x800001e8]:fcvt.w.s s2, fa0, dyn<br> [0x800001ec]:csrrs a7, fflags, zero<br> [0x800001f0]:sw s2, 16(a5)<br>     |
|   3|[0x80002230]<br>0xFFFFFFFF80000000|- rd : x16<br> - rs1 : f20<br> - fs1 == 1 and fe1 == 0x9e and fm1 == 0x000000 and rm_val == 0  #nosat<br>                       |[0x8000020c]:fcvt.w.s a6, fs4, dyn<br> [0x80000210]:csrrs s5, fflags, zero<br> [0x80000214]:sw a6, 0(s3)<br>      |
|   4|[0x80002240]<br>0xFFFFFFFF9A616D80|- rd : x28<br> - rs1 : f0<br> - fs1 == 1 and fe1 == 0x9d and fm1 == 0x4b3d25 and rm_val == 0  #nosat<br>                        |[0x80000230]:fcvt.w.s t3, ft0, dyn<br> [0x80000234]:csrrs a7, fflags, zero<br> [0x80000238]:sw t3, 0(a5)<br>      |
|   5|[0x80002250]<br>0xFFFFFFFFFFFFFFFF|- rd : x4<br> - rs1 : f6<br> - fs1 == 1 and fe1 == 0x7f and fm1 == 0x200000 and rm_val == 0  #nosat<br>                         |[0x80000248]:fcvt.w.s tp, ft6, dyn<br> [0x8000024c]:csrrs a7, fflags, zero<br> [0x80000250]:sw tp, 16(a5)<br>     |
|   6|[0x80002260]<br>0xFFFFFFFFFFFFFFFE|- rd : x12<br> - rs1 : f12<br> - fs1 == 1 and fe1 == 0x7f and fm1 == 0x400000 and rm_val == 0  #nosat<br>                       |[0x80000260]:fcvt.w.s a2, fa2, dyn<br> [0x80000264]:csrrs a7, fflags, zero<br> [0x80000268]:sw a2, 32(a5)<br>     |
|   7|[0x80002270]<br>0xFFFFFFFFFFFFFFFE|- rd : x7<br> - rs1 : f1<br> - fs1 == 1 and fe1 == 0x7f and fm1 == 0x600000 and rm_val == 0  #nosat<br>                         |[0x80000278]:fcvt.w.s t2, ft1, dyn<br> [0x8000027c]:csrrs a7, fflags, zero<br> [0x80000280]:sw t2, 48(a5)<br>     |
|   8|[0x80002280]<br>0xFFFFFFFFFFFFFFFE|- rd : x21<br> - rs1 : f15<br> - fs1 == 1 and fe1 == 0x80 and fm1 == 0x000000 and rm_val == 0  #nosat<br>                       |[0x80000290]:fcvt.w.s s5, fa5, dyn<br> [0x80000294]:csrrs a7, fflags, zero<br> [0x80000298]:sw s5, 64(a5)<br>     |
|   9|[0x80002290]<br>0xFFFFFFFFFFFFFFFE|- rd : x31<br> - rs1 : f16<br> - fs1 == 1 and fe1 == 0x80 and fm1 == 0x100000 and rm_val == 0  #nosat<br>                       |[0x800002a8]:fcvt.w.s t6, fa6, dyn<br> [0x800002ac]:csrrs a7, fflags, zero<br> [0x800002b0]:sw t6, 80(a5)<br>     |
|  10|[0x800022a0]<br>0xFFFFFFFFFFFFFFFE|- rd : x17<br> - rs1 : f8<br> - fs1 == 1 and fe1 == 0x80 and fm1 == 0x200000 and rm_val == 0  #nosat<br>                        |[0x800002cc]:fcvt.w.s a7, fs0, dyn<br> [0x800002d0]:csrrs s5, fflags, zero<br> [0x800002d4]:sw a7, 0(s3)<br>      |
|  11|[0x800022b0]<br>0xFFFFFFFFFFFFFFFD|- rd : x15<br> - rs1 : f3<br> - fs1 == 1 and fe1 == 0x80 and fm1 == 0x300000 and rm_val == 0  #nosat<br>                        |[0x800002e4]:fcvt.w.s a5, ft3, dyn<br> [0x800002e8]:csrrs s5, fflags, zero<br> [0x800002ec]:sw a5, 16(s3)<br>     |
|  12|[0x800022c0]<br>0xFFFFFFFFFFFFFFFF|- rd : x10<br> - rs1 : f18<br> - fs1 == 1 and fe1 == 0x7f and fm1 == 0x000000 and rm_val == 0  #nosat<br>                       |[0x80000308]:fcvt.w.s a0, fs2, dyn<br> [0x8000030c]:csrrs a7, fflags, zero<br> [0x80000310]:sw a0, 0(a5)<br>      |
|  13|[0x800022d0]<br>0x0000000000000000|- rd : x26<br> - rs1 : f23<br> - fs1 == 1 and fe1 == 0x7d and fm1 == 0x58046a and rm_val == 0  #nosat<br>                       |[0x80000320]:fcvt.w.s s10, fs7, dyn<br> [0x80000324]:csrrs a7, fflags, zero<br> [0x80000328]:sw s10, 16(a5)<br>   |
|  14|[0x800022e0]<br>0x0000000000000000|- rd : x19<br> - rs1 : f28<br> - fs1 == 1 and fe1 == 0x00 and fm1 == 0x000000 and rm_val == 0  #nosat<br>                       |[0x80000338]:fcvt.w.s s3, ft8, dyn<br> [0x8000033c]:csrrs a7, fflags, zero<br> [0x80000340]:sw s3, 32(a5)<br>     |
|  15|[0x800022f0]<br>0x000000007FFFFFFF|- rd : x30<br> - rs1 : f13<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x400001 and rm_val == 0  #nosat<br>                       |[0x80000350]:fcvt.w.s t5, fa3, dyn<br> [0x80000354]:csrrs a7, fflags, zero<br> [0x80000358]:sw t5, 48(a5)<br>     |
|  16|[0x80002300]<br>0x000000007FFFFFFF|- rd : x2<br> - rs1 : f11<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x000001 and rm_val == 0  #nosat<br>                        |[0x80000368]:fcvt.w.s sp, fa1, dyn<br> [0x8000036c]:csrrs a7, fflags, zero<br> [0x80000370]:sw sp, 64(a5)<br>     |
|  17|[0x80002310]<br>0x000000007FFFFFFF|- rd : x24<br> - rs1 : f29<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x000000 and rm_val == 0  #nosat<br>                       |[0x80000380]:fcvt.w.s s8, ft9, dyn<br> [0x80000384]:csrrs a7, fflags, zero<br> [0x80000388]:sw s8, 80(a5)<br>     |
|  18|[0x80002320]<br>0x000000007FFFFF80|- rd : x1<br> - rs1 : f14<br> - fs1 == 0 and fe1 == 0x9d and fm1 == 0x7fffff and rm_val == 0  #nosat<br>                        |[0x80000398]:fcvt.w.s ra, fa4, dyn<br> [0x8000039c]:csrrs a7, fflags, zero<br> [0x800003a0]:sw ra, 96(a5)<br>     |
|  19|[0x80002330]<br>0x0000000036E5D600|- rd : x22<br> - rs1 : f27<br> - fs1 == 0 and fe1 == 0x9c and fm1 == 0x5b9758 and rm_val == 0  #nosat<br>                       |[0x800003b0]:fcvt.w.s s6, fs11, dyn<br> [0x800003b4]:csrrs a7, fflags, zero<br> [0x800003b8]:sw s6, 112(a5)<br>   |
|  20|[0x80002340]<br>0x0000000000000003|- rd : x14<br> - rs1 : f26<br> - fs1 == 0 and fe1 == 0x80 and fm1 == 0x300000 and rm_val == 0  #nosat<br>                       |[0x800003c8]:fcvt.w.s a4, fs10, dyn<br> [0x800003cc]:csrrs a7, fflags, zero<br> [0x800003d0]:sw a4, 128(a5)<br>   |
|  21|[0x80002350]<br>0x0000000000000002|- rd : x25<br> - rs1 : f19<br> - fs1 == 0 and fe1 == 0x80 and fm1 == 0x200000 and rm_val == 0  #nosat<br>                       |[0x800003e0]:fcvt.w.s s9, fs3, dyn<br> [0x800003e4]:csrrs a7, fflags, zero<br> [0x800003e8]:sw s9, 144(a5)<br>    |
|  22|[0x80002360]<br>0x0000000000000002|- rd : x8<br> - rs1 : f4<br> - fs1 == 0 and fe1 == 0x80 and fm1 == 0x100000 and rm_val == 0  #nosat<br>                         |[0x800003f8]:fcvt.w.s fp, ft4, dyn<br> [0x800003fc]:csrrs a7, fflags, zero<br> [0x80000400]:sw fp, 160(a5)<br>    |
|  23|[0x80002370]<br>0x0000000000000002|- rd : x11<br> - rs1 : f5<br> - fs1 == 0 and fe1 == 0x80 and fm1 == 0x000000 and rm_val == 0  #nosat<br>                        |[0x80000410]:fcvt.w.s a1, ft5, dyn<br> [0x80000414]:csrrs a7, fflags, zero<br> [0x80000418]:sw a1, 176(a5)<br>    |
|  24|[0x80002380]<br>0x0000000000000002|- rd : x29<br> - rs1 : f30<br> - fs1 == 0 and fe1 == 0x7f and fm1 == 0x600000 and rm_val == 0  #nosat<br>                       |[0x80000428]:fcvt.w.s t4, ft10, dyn<br> [0x8000042c]:csrrs a7, fflags, zero<br> [0x80000430]:sw t4, 192(a5)<br>   |
|  25|[0x80002390]<br>0x0000000000000002|- rd : x5<br> - rs1 : f22<br> - fs1 == 0 and fe1 == 0x7f and fm1 == 0x400000 and rm_val == 0  #nosat<br>                        |[0x80000440]:fcvt.w.s t0, fs6, dyn<br> [0x80000444]:csrrs a7, fflags, zero<br> [0x80000448]:sw t0, 208(a5)<br>    |
|  26|[0x800023a0]<br>0x0000000000000001|- rd : x27<br> - rs1 : f31<br> - fs1 == 0 and fe1 == 0x7f and fm1 == 0x200000 and rm_val == 0  #nosat<br>                       |[0x80000458]:fcvt.w.s s11, ft11, dyn<br> [0x8000045c]:csrrs a7, fflags, zero<br> [0x80000460]:sw s11, 224(a5)<br> |
|  27|[0x800023b0]<br>0x0000000000000001|- rd : x20<br> - rs1 : f25<br> - fs1 == 0 and fe1 == 0x7f and fm1 == 0x000000 and rm_val == 0  #nosat<br>                       |[0x80000470]:fcvt.w.s s4, fs9, dyn<br> [0x80000474]:csrrs a7, fflags, zero<br> [0x80000478]:sw s4, 240(a5)<br>    |
|  28|[0x800023c0]<br>0x0000000000000001|- rd : x23<br> - rs1 : f21<br> - fs1 == 0 and fe1 == 0x7e and fm1 == 0x124770 and rm_val == 0  #nosat<br>                       |[0x80000488]:fcvt.w.s s7, fs5, dyn<br> [0x8000048c]:csrrs a7, fflags, zero<br> [0x80000490]:sw s7, 256(a5)<br>    |
|  29|[0x800023d0]<br>0x0000000000000000|- rd : x13<br> - rs1 : f2<br>                                                                                                   |[0x800004a0]:fcvt.w.s a3, ft2, dyn<br> [0x800004a4]:csrrs a7, fflags, zero<br> [0x800004a8]:sw a3, 272(a5)<br>    |
|  30|[0x800023e0]<br>0x0000000000000000|- rd : x6<br> - rs1 : f7<br>                                                                                                    |[0x800004b8]:fcvt.w.s t1, ft7, dyn<br> [0x800004bc]:csrrs a7, fflags, zero<br> [0x800004c0]:sw t1, 288(a5)<br>    |
|  31|[0x800023f0]<br>0x0000000000000000|- rd : x9<br> - rs1 : f24<br>                                                                                                   |[0x800004d0]:fcvt.w.s s1, fs8, dyn<br> [0x800004d4]:csrrs a7, fflags, zero<br> [0x800004d8]:sw s1, 304(a5)<br>    |
|  32|[0x80002400]<br>0x0000000000000000|- rd : x3<br> - rs1 : f17<br>                                                                                                   |[0x800004e8]:fcvt.w.s gp, fa7, dyn<br> [0x800004ec]:csrrs a7, fflags, zero<br> [0x800004f0]:sw gp, 320(a5)<br>    |
