...
|---:|----------------------------------|----------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|
|   1|[0x80002210]<br>0x0000000000000000|- opcode : fcvt.wu.s<br> - rd : x3<br> - rs1 : f16<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x000000 and rm_val == 0  #nosat<br> |[0x800001d0]:fcvt.wu.s gp, fa6, dyn<br> [0x800001d4]:csrrs a7, fflags, zero<br> [0x800001d8]:sw gp, 0(a5)<br>      |
|   2|[0x80002220]<br>0x0000000000000000|- rd : x4<br> - rs1 : f0<br> - fs1 == 1 and fe1 == 0xff and fm1 == 0x000000 and rm_val == 0  #nosat<br>                           |[0x800001e8]:fcvt.wu.s tp, ft0, dyn<br> [0x800001ec]:csrrs a7, fflags, zero<br> [0x800001f0]:sw tp, 16(a5)<br>     |
|   3|[0x80002230]<br>0x0000000000000000|- rd : x28<br> - rs1 : f6<br> - fs1 == 1 and fe1 == 0x9e and fm1 == 0x000000 and rm_val == 0  #nosat<br>                          |[0x80000200]:fcvt.wu.s t3, ft6, dyn<br> [0x80000204]:csrrs a7, fflags, zero<br> [0x80000208]:sw t3, 32(a5)<br>     |
|   4|[0x80002240]<br>0x0000000000000000|- rd : x11<br> - rs1 : f26<br> - fs1 == 1 and fe1 == 0x9d and fm1 == 0x4b3d25 and rm_val == 0  #nosat<br>                         |[0x80000218]:fcvt.wu.s a1, fs10, dyn<br> [0x8000021c]:csrrs a7, fflags, zero<br> [0x80000220]:sw a1, 48(a5)<br>    |
|   5|[0x80002250]<br>0x0000000000000000|- rd : x7<br> - rs1 : f20<br> - fs1 == 1 and fe1 == 0x7f and fm1 == 0x200000 and rm_val == 0  #nosat<br>                          |[0x80000230]:fcvt.wu.s t2, fs4, dyn<br> [0x80000234]:csrrs a7, fflags, zero<br> [0x80000238]:sw t2, 64(a5)<br>     |
|   6|[0x80002260]<br>0x0000000000000000|- rd : x15<br> - rs1 : f19<br> - fs1 == 1 and fe1 == 0x7f and fm1 == 0x400000 and rm_val == 0  #nosat<br>                         |[0x80000254]:fcvt.wu.s a5, fs3, dyn<br> [0x80000258]:csrrs s5, fflags, zero<br> [0x8000025c]:sw a5, 0(s3)<br>      |
|   7|[0x80002270]<br>0x0000000000000000|- rd : x22<br> - rs1 : f24<br> - fs1 == 1 and fe1 == 0x7f and fm1 == 0x600000 and rm_val == 0  #nosat<br>                         |[0x80000278]:fcvt.wu.s s6, fs8, dyn<br> [0x8000027c]:csrrs a7, fflags, zero<br> [0x80000280]:sw s6, 0(a5)<br>      |
|   8|[0x80002280]<br>0x0000000000000000|- rd : x29<br> - rs1 : f12<br> - fs1 == 1 and fe1 == 0x80 and fm1 == 0x000000 and rm_val == 0  #nosat<br>                         |[0x80000290]:fcvt.wu.s t4, fa2, dyn<br> [0x80000294]:csrrs a7, fflags, zero<br> [0x80000298]:sw t4, 16(a5)<br>     |
|   9|[0x80002290]<br>0x0000000000000000|- rd : x25<br> - rs1 : f14<br> - fs1 == 1 and fe1 == 0x80 and fm1 == 0x100000 and rm_val == 0  #nosat<br>                         |[0x800002a8]:fcvt.wu.s s9, fa4, dyn<br> [0x800002ac]:csrrs a7, fflags, zero<br> [0x800002b0]:sw s9, 32(a5)<br>     |
|  10|[0x800022a0]<br>0x0000000000000000|- rd : x10<br> - rs1 : f25<br> - fs1 == 1 and fe1 == 0x80 and fm1 == 0x200000 and rm_val == 0  #nosat<br>                         |[0x800002c0]:fcvt.wu.s a0, fs9, dyn<br> [0x800002c4]:csrrs a7, fflags, zero<br> [0x800002c8]:sw a0, 48(a5)<br>     |
|  11|[0x800022b0]<br>0x0000000000000000|- rd : x30<br> - rs1 : f28<br> - fs1 == 1 and fe1 == 0x80 and fm1 == 0x300000 and rm_val == 0  #nosat<br>                         |[0x800002d8]:fcvt.wu.s t5, ft8, dyn<br> [0x800002dc]:csrrs a7, fflags, zero<br> [0x800002e0]:sw t5, 64(a5)<br>     |
|  12|[0x800022c0]<br>0x0000000000000000|- rd : x24<br> - rs1 : f23<br> - fs1 == 1 and fe1 == 0x7f and fm1 == 0x000000 and rm_val == 0  #nosat<br>                         |[0x800002f0]:fcvt.wu.s s8, fs7, dyn<br> [0x800002f4]:csrrs a7, fflags, zero<br> [0x800002f8]:sw s8, 80(a5)<br>     |
|  13|[0x800022d0]<br>0x0000000000000000|- rd : x12<br> - rs1 : f10<br> - fs1 == 1 and fe1 == 0x7d and fm1 == 0x58046a and rm_val == 0  #nosat<br>                         |[0x80000308]:fcvt.wu.s a2, fa0, dyn<br> [0x8000030c]:csrrs a7, fflags, zero<br> [0x80000310]:sw a2, 96(a5)<br>     |
|  14|[0x800022e0]<br>0x0000000000000000|- rd : x23<br> - rs1 : f15<br> - fs1 == 1 and fe1 == 0x00 and fm1 == 0x000000 and rm_val == 0  #nosat<br>                         |[0x80000320]:fcvt.wu.s s7, fa5, dyn<br> [0x80000324]:csrrs a7, fflags, zero<br> [0x80000328]:sw s7, 112(a5)<br>    |
|  15|[0x800022f0]<br>0xFFFFFFFFFFFFFFFF|- rd : x16<br> - rs1 : f5<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x400001 and rm_val == 0  #nosat<br>                          |[0x80000344]:fcvt.wu.s a6, ft5, dyn<br> [0x80000348]:csrrs s5, fflags, zero<br> [0x8000034c]:sw a6, 0(s3)<br>      |
|  16|[0x80002300]<br>0xFFFFFFFFFFFFFFFF|- rd : x2<br> - rs1 : f1<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x000001 and rm_val == 0  #nosat<br>                           |[0x80000368]:fcvt.wu.s sp, ft1, dyn<br> [0x8000036c]:csrrs a7, fflags, zero<br> [0x80000370]:sw sp, 0(a5)<br>      |
|  17|[0x80002310]<br>0xFFFFFFFFFFFFFFFF|- rd : x26<br> - rs1 : f27<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x000000 and rm_val == 0  #nosat<br>                         |[0x80000380]:fcvt.wu.s s10, fs11, dyn<br> [0x80000384]:csrrs a7, fflags, zero<br> [0x80000388]:sw s10, 16(a5)<br>  |
|  18|[0x80002320]<br>0x000000007FFFFF80|- rd : x14<br> - rs1 : f22<br> - fs1 == 0 and fe1 == 0x9d and fm1 == 0x7fffff and rm_val == 0  #nosat<br>                         |[0x80000398]:fcvt.wu.s a4, fs6, dyn<br> [0x8000039c]:csrrs a7, fflags, zero<br> [0x800003a0]:sw a4, 32(a5)<br>     |
|  19|[0x80002330]<br>0x0000000036E5D600|- rd : x6<br> - rs1 : f31<br> - fs1 == 0 and fe1 == 0x9c and fm1 == 0x5b9758 and rm_val == 0  #nosat<br>                          |[0x800003b0]:fcvt.wu.s t1, ft11, dyn<br> [0x800003b4]:csrrs a7, fflags, zero<br> [0x800003b8]:sw t1, 48(a5)<br>    |
|  20|[0x80002340]<br>0x0000000000000003|- rd : x27<br> - rs1 : f4<br> - fs1 == 0 and fe1 == 0x80 and fm1 == 0x300000 and rm_val == 0  #nosat<br>                          |[0x800003c8]:fcvt.wu.s s11, ft4, dyn<br> [0x800003cc]:csrrs a7, fflags, zero<br> [0x800003d0]:sw s11, 64(a5)<br>   |
|  21|[0x80002350]<br>0x0000000000000002|- rd : x1<br> - rs1 : f17<br> - fs1 == 0 and fe1 == 0x80 and fm1 == 0x200000 and rm_val == 0  #nosat<br>                          |[0x800003e0]:fcvt.wu.s ra, fa7, dyn<br> [0x800003e4]:csrrs a7, fflags, zero<br> [0x800003e8]:sw ra, 80(a5)<br>     |
|  22|[0x80002360]<br>0x0000000000000002|- rd : x17<br> - rs1 : f3<br> - fs1 == 0 and fe1 == 0x80 and fm1 == 0x100000 and rm_val == 0  #nosat<br>                          |[0x80000404]:fcvt.wu.s a7, ft3, dyn<br> [0x80000408]:csrrs s5, fflags, zero<br> [0x8000040c]:sw a7, 0(s3)<br>      |
|  23|[0x80002370]<br>0x0000000000000002|- rd : x5<br> - rs1 : f30<br> - fs1 == 0 and fe1 == 0x80 and fm1 == 0x000000 and rm_val == 0  #nosat<br>                          |[0x80000428]:fcvt.wu.s t0, ft10, dyn<br> [0x8000042c]:csrrs a7, fflags, zero<br> [0x80000430]:sw t0, 0(a5)<br>     |
|  24|[0x80002380]<br>0x0000000000000002|- rd : x13<br> - rs1 : f29<br> - fs1 == 0 and fe1 == 0x7f and fm1 == 0x600000 and rm_val == 0  #nosat<br>                         |[0x80000440]:fcvt.wu.s a3, ft9, dyn<br> [0x80000444]:csrrs a7, fflags, zero<br> [0x80000448]:sw a3, 16(a5)<br>     |
|  25|[0x80002390]<br>0x0000000000000000|- rd : x0<br> - rs1 : f8<br> - fs1 == 0 and fe1 == 0x7f and fm1 == 0x400000 and rm_val == 0  #nosat<br>                           |[0x80000458]:fcvt.wu.s zero, fs0, dyn<br> [0x8000045c]:csrrs a7, fflags, zero<br> [0x80000460]:sw zero, 32(a5)<br> |
|  26|[0x800023a0]<br>0x0000000000000001|- rd : x9<br> - rs1 : f9<br> - fs1 == 0 and fe1 == 0x7f and fm1 == 0x200000 and rm_val == 0  #nosat<br>                           |[0x80000470]:fcvt.wu.s s1, fs1, dyn<br> [0x80000474]:csrrs a7, fflags, zero<br> [0x80000478]:sw s1, 48(a5)<br>     |
|  27|[0x800023b0]<br>0x0000000000000001|- rd : x21<br> - rs1 : f2<br> - fs1 == 0 and fe1 == 0x7f and fm1 == 0x000000 and rm_val == 0  #nosat<br>                          |[0x80000488]:fcvt.wu.s s5, ft2, dyn<br> [0x8000048c]:csrrs a7, fflags, zero<br> [0x80000490]:sw s5, 64(a5)<br>     |
|  28|[0x800023c0]<br>0x0000000000000001|- rd : x18<br> - rs1 : f11<br> - fs1 == 0 and fe1 == 0x7e and fm1 == 0x124770 and rm_val == 0  #nosat<br>                         |[0x800004a0]:fcvt.wu.s s2, fa1, dyn<br> [0x800004a4]:csrrs a7, fflags, zero<br> [0x800004a8]:sw s2, 80(a5)<br>     |
|  29|[0x800023d0]<br>0x0000000000000000|- rd : x19<br> - rs1 : f18<br>                                                                                                    |[0x800004b8]:fcvt.wu.s s3, fs2, dyn<br> [0x800004bc]:csrrs a7, fflags, zero<br> [0x800004c0]:sw s3, 96(a5)<br>     |
|  30|[0x800023e0]<br>0x0000000000000000|- rd : x20<br> - rs1 : f13<br>                                                                                                    |[0x800004d0]:fcvt.wu.s s4, fa3, dyn<br> [0x800004d4]:csrrs a7, fflags, zero<br> [0x800004d8]:sw s4, 112(a5)<br>    |
|  31|[0x800023f0]<br>0x0000000000000000|- rd : x8<br> - rs1 : f21<br>                                                                                                     |[0x800004e8]:fcvt.wu.s fp, fs5, dyn<br> [0x800004ec]:csrrs a7, fflags, zero<br> [0x800004f0]:sw fp, 128(a5)<br>    |
|  32|[0x80002400]<br>0x0000000000000000|- rd : x31<br> - rs1 : f7<br>                                                                                                     |[0x80000500]:fcvt.wu.s t6, ft7, dyn<br> [0x80000504]:csrrs a7, fflags, zero<br> [0x80000508]:sw t6, 144(a5)<br>    |
