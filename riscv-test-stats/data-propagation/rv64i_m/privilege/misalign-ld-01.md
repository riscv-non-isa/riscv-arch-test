...
Last Code Sequence : 
	-[0x800003ac]:ld a1, 64(a0)
Current Store : [0x80000798] : sd t2, 24(t1) -- Store: [0x800020f0]:0x0000000000000000
...
Last Code Sequence : 
	-[0x800003c4]:ld a1, 3071(a0)
Current Store : [0x80000798] : sd t2, 24(t1) -- Store: [0x80002110]:0x0000000000000000
...
Last Code Sequence : 
	-[0x800003dc]:ld a1, 4031(a0)
Current Store : [0x80000798] : sd t2, 24(t1) -- Store: [0x80002130]:0x0000000000000000
...
Last Code Sequence : 
	-[0x800003f4]:ld a1, 2047(a0)
Current Store : [0x80000798] : sd t2, 24(t1) -- Store: [0x80002150]:0x0000000000000000
...
Last Code Sequence : 
	-[0x8000040c]:ld a1, 4087(a0)
Current Store : [0x80000798] : sd t2, 24(t1) -- Store: [0x80002170]:0x0000000000000000
...
Last Code Sequence : 
	-[0x80000424]:ld a1, 4087(a0)
Current Store : [0x80000798] : sd t2, 24(t1) -- Store: [0x80002190]:0x0000000000000000
...
Last Code Sequence : 
	-[0x8000043c]:ld a1, 8(a0)
Current Store : [0x80000798] : sd t2, 24(t1) -- Store: [0x800021b0]:0x0000000000000000
...
|---:|----------------------------------|--------------------------------------|---------------------------------|
|   1|[0x800020d8]<br>0x000000000000010F|- opcode : ld<br> - ea_align == 1<br> |[0x800003ac]:ld a1, 64(a0)<br>   |
|   2|[0x800020f8]<br>0x000000000000010F|- ea_align == 2<br>                   |[0x800003c4]:ld a1, 3071(a0)<br> |
|   3|[0x80002118]<br>0x000000000000010F|- ea_align == 3<br>                   |[0x800003dc]:ld a1, 4031(a0)<br> |
|   4|[0x80002138]<br>0x000000000000010F|- ea_align == 4<br>                   |[0x800003f4]:ld a1, 2047(a0)<br> |
|   5|[0x80002158]<br>0x000000000000010F|- ea_align == 5<br>                   |[0x8000040c]:ld a1, 4087(a0)<br> |
|   6|[0x80002178]<br>0x000000000000010F|- ea_align == 6<br>                   |[0x80000424]:ld a1, 4087(a0)<br> |
|   7|[0x80002198]<br>0x000000000000010F|- ea_align == 7<br>                   |[0x8000043c]:ld a1, 8(a0)<br>    |
