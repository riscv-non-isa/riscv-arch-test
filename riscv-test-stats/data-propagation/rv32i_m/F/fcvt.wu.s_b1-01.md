...
|---:|--------------------------|-----------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|
|   1|[0x80002204]<br>0x00000000|- opcode : fcvt.wu.s<br> - rd : x26<br> - rs1 : f22<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x000000 and rm_val == 0  #nosat<br> |[0x80000120]:fcvt.wu.s s10, fs6, dyn<br> [0x80000124]:csrrs a7, fflags, zero<br> [0x80000128]:sw s10, 0(a5)<br>    |
|   2|[0x8000220c]<br>0x00000000|- rd : x6<br> - rs1 : f30<br> - fs1 == 1 and fe1 == 0x7f and fm1 == 0x000000 and rm_val == 0  #nosat<br>                           |[0x80000138]:fcvt.wu.s t1, ft10, dyn<br> [0x8000013c]:csrrs a7, fflags, zero<br> [0x80000140]:sw t1, 8(a5)<br>     |
|   3|[0x80002214]<br>0x00000001|- rd : x25<br> - rs1 : f7<br> - fs1 == 0 and fe1 == 0x7f and fm1 == 0x000000 and rm_val == 0  #nosat<br>                           |[0x80000150]:fcvt.wu.s s9, ft7, dyn<br> [0x80000154]:csrrs a7, fflags, zero<br> [0x80000158]:sw s9, 16(a5)<br>     |
|   4|[0x8000221c]<br>0xFFFFFFFF|- rd : x24<br> - rs1 : f10<br> - fs1 == 1 and fe1 == 0xff and fm1 == 0x2aaaaa and rm_val == 0  #nosat<br>                          |[0x80000168]:fcvt.wu.s s8, fa0, dyn<br> [0x8000016c]:csrrs a7, fflags, zero<br> [0x80000170]:sw s8, 24(a5)<br>     |
|   5|[0x80002224]<br>0xFFFFFFFF|- rd : x3<br> - rs1 : f19<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x000001 and rm_val == 0  #nosat<br>                           |[0x80000180]:fcvt.wu.s gp, fs3, dyn<br> [0x80000184]:csrrs a7, fflags, zero<br> [0x80000188]:sw gp, 32(a5)<br>     |
|   6|[0x8000222c]<br>0xFFFFFFFF|- rd : x31<br> - rs1 : f11<br> - fs1 == 1 and fe1 == 0xff and fm1 == 0x455555 and rm_val == 0  #nosat<br>                          |[0x80000198]:fcvt.wu.s t6, fa1, dyn<br> [0x8000019c]:csrrs a7, fflags, zero<br> [0x800001a0]:sw t6, 40(a5)<br>     |
|   7|[0x80002234]<br>0xFFFFFFFF|- rd : x16<br> - rs1 : f1<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x400001 and rm_val == 0  #nosat<br>                           |[0x800001bc]:fcvt.wu.s a6, ft1, dyn<br> [0x800001c0]:csrrs s5, fflags, zero<br> [0x800001c4]:sw a6, 0(s3)<br>      |
|   8|[0x8000223c]<br>0xFFFFFFFF|- rd : x28<br> - rs1 : f18<br> - fs1 == 1 and fe1 == 0xff and fm1 == 0x400000 and rm_val == 0  #nosat<br>                          |[0x800001e0]:fcvt.wu.s t3, fs2, dyn<br> [0x800001e4]:csrrs a7, fflags, zero<br> [0x800001e8]:sw t3, 0(a5)<br>      |
|   9|[0x80002244]<br>0xFFFFFFFF|- rd : x4<br> - rs1 : f17<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x400000 and rm_val == 0  #nosat<br>                           |[0x800001f8]:fcvt.wu.s tp, fa7, dyn<br> [0x800001fc]:csrrs a7, fflags, zero<br> [0x80000200]:sw tp, 8(a5)<br>      |
|  10|[0x8000224c]<br>0x00000000|- rd : x12<br> - rs1 : f5<br> - fs1 == 1 and fe1 == 0xff and fm1 == 0x000000 and rm_val == 0  #nosat<br>                           |[0x80000210]:fcvt.wu.s a2, ft5, dyn<br> [0x80000214]:csrrs a7, fflags, zero<br> [0x80000218]:sw a2, 16(a5)<br>     |
|  11|[0x80002254]<br>0xFFFFFFFF|- rd : x20<br> - rs1 : f25<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x000000 and rm_val == 0  #nosat<br>                          |[0x80000228]:fcvt.wu.s s4, fs9, dyn<br> [0x8000022c]:csrrs a7, fflags, zero<br> [0x80000230]:sw s4, 24(a5)<br>     |
|  12|[0x8000225c]<br>0x00000000|- rd : x18<br> - rs1 : f21<br> - fs1 == 1 and fe1 == 0xfe and fm1 == 0x7fffff and rm_val == 0  #nosat<br>                          |[0x80000240]:fcvt.wu.s s2, fs5, dyn<br> [0x80000244]:csrrs a7, fflags, zero<br> [0x80000248]:sw s2, 32(a5)<br>     |
|  13|[0x80002264]<br>0x00000000|- rd : x0<br> - rs1 : f0<br> - fs1 == 0 and fe1 == 0xfe and fm1 == 0x7fffff and rm_val == 0  #nosat<br>                            |[0x80000258]:fcvt.wu.s zero, ft0, dyn<br> [0x8000025c]:csrrs a7, fflags, zero<br> [0x80000260]:sw zero, 40(a5)<br> |
|  14|[0x8000226c]<br>0x00000000|- rd : x29<br> - rs1 : f23<br> - fs1 == 1 and fe1 == 0x01 and fm1 == 0x055555 and rm_val == 0  #nosat<br>                          |[0x80000270]:fcvt.wu.s t4, fs7, dyn<br> [0x80000274]:csrrs a7, fflags, zero<br> [0x80000278]:sw t4, 48(a5)<br>     |
|  15|[0x80002274]<br>0x00000000|- rd : x10<br> - rs1 : f16<br> - fs1 == 0 and fe1 == 0x01 and fm1 == 0x000001 and rm_val == 0  #nosat<br>                          |[0x80000288]:fcvt.wu.s a0, fa6, dyn<br> [0x8000028c]:csrrs a7, fflags, zero<br> [0x80000290]:sw a0, 56(a5)<br>     |
|  16|[0x8000227c]<br>0x00000000|- rd : x13<br> - rs1 : f31<br> - fs1 == 1 and fe1 == 0x01 and fm1 == 0x000000 and rm_val == 0  #nosat<br>                          |[0x800002a0]:fcvt.wu.s a3, ft11, dyn<br> [0x800002a4]:csrrs a7, fflags, zero<br> [0x800002a8]:sw a3, 64(a5)<br>    |
|  17|[0x80002284]<br>0x00000000|- rd : x5<br> - rs1 : f26<br> - fs1 == 0 and fe1 == 0x01 and fm1 == 0x000000 and rm_val == 0  #nosat<br>                           |[0x800002b8]:fcvt.wu.s t0, fs10, dyn<br> [0x800002bc]:csrrs a7, fflags, zero<br> [0x800002c0]:sw t0, 72(a5)<br>    |
|  18|[0x8000228c]<br>0x00000000|- rd : x11<br> - rs1 : f14<br> - fs1 == 1 and fe1 == 0x00 and fm1 == 0x7fffff and rm_val == 0  #nosat<br>                          |[0x800002d0]:fcvt.wu.s a1, fa4, dyn<br> [0x800002d4]:csrrs a7, fflags, zero<br> [0x800002d8]:sw a1, 80(a5)<br>     |
|  19|[0x80002294]<br>0x00000000|- rd : x9<br> - rs1 : f12<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x7fffff and rm_val == 0  #nosat<br>                           |[0x800002e8]:fcvt.wu.s s1, fa2, dyn<br> [0x800002ec]:csrrs a7, fflags, zero<br> [0x800002f0]:sw s1, 88(a5)<br>     |
|  20|[0x8000229c]<br>0x00000000|- rd : x22<br> - rs1 : f2<br> - fs1 == 1 and fe1 == 0x00 and fm1 == 0x7ffffe and rm_val == 0  #nosat<br>                           |[0x80000300]:fcvt.wu.s s6, ft2, dyn<br> [0x80000304]:csrrs a7, fflags, zero<br> [0x80000308]:sw s6, 96(a5)<br>     |
|  21|[0x800022a4]<br>0x00000000|- rd : x1<br> - rs1 : f3<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x000002 and rm_val == 0  #nosat<br>                            |[0x80000318]:fcvt.wu.s ra, ft3, dyn<br> [0x8000031c]:csrrs a7, fflags, zero<br> [0x80000320]:sw ra, 104(a5)<br>    |
|  22|[0x800022ac]<br>0x00000000|- rd : x8<br> - rs1 : f13<br> - fs1 == 1 and fe1 == 0x00 and fm1 == 0x000001 and rm_val == 0  #nosat<br>                           |[0x80000330]:fcvt.wu.s fp, fa3, dyn<br> [0x80000334]:csrrs a7, fflags, zero<br> [0x80000338]:sw fp, 112(a5)<br>    |
|  23|[0x800022b4]<br>0x00000000|- rd : x27<br> - rs1 : f24<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x000001 and rm_val == 0  #nosat<br>                          |[0x80000348]:fcvt.wu.s s11, fs8, dyn<br> [0x8000034c]:csrrs a7, fflags, zero<br> [0x80000350]:sw s11, 120(a5)<br>  |
|  24|[0x800022bc]<br>0x00000000|- rd : x23<br> - rs1 : f29<br> - fs1 == 1 and fe1 == 0x00 and fm1 == 0x000000 and rm_val == 0  #nosat<br>                          |[0x80000360]:fcvt.wu.s s7, ft9, dyn<br> [0x80000364]:csrrs a7, fflags, zero<br> [0x80000368]:sw s7, 128(a5)<br>    |
|  25|[0x800022c4]<br>0x00000000|- rd : x17<br> - rs1 : f6<br>                                                                                                      |[0x80000384]:fcvt.wu.s a7, ft6, dyn<br> [0x80000388]:csrrs s5, fflags, zero<br> [0x8000038c]:sw a7, 0(s3)<br>      |
|  26|[0x800022cc]<br>0x00000000|- rd : x7<br> - rs1 : f27<br>                                                                                                      |[0x800003a8]:fcvt.wu.s t2, fs11, dyn<br> [0x800003ac]:csrrs a7, fflags, zero<br> [0x800003b0]:sw t2, 0(a5)<br>     |
|  27|[0x800022d4]<br>0x00000000|- rd : x15<br> - rs1 : f15<br>                                                                                                     |[0x800003cc]:fcvt.wu.s a5, fa5, dyn<br> [0x800003d0]:csrrs s5, fflags, zero<br> [0x800003d4]:sw a5, 0(s3)<br>      |
|  28|[0x800022dc]<br>0x00000000|- rd : x30<br> - rs1 : f9<br>                                                                                                      |[0x800003f0]:fcvt.wu.s t5, fs1, dyn<br> [0x800003f4]:csrrs a7, fflags, zero<br> [0x800003f8]:sw t5, 0(a5)<br>      |
|  29|[0x800022e4]<br>0x00000000|- rd : x19<br> - rs1 : f20<br>                                                                                                     |[0x80000408]:fcvt.wu.s s3, fs4, dyn<br> [0x8000040c]:csrrs a7, fflags, zero<br> [0x80000410]:sw s3, 8(a5)<br>      |
|  30|[0x800022ec]<br>0x00000000|- rd : x21<br> - rs1 : f4<br>                                                                                                      |[0x80000420]:fcvt.wu.s s5, ft4, dyn<br> [0x80000424]:csrrs a7, fflags, zero<br> [0x80000428]:sw s5, 16(a5)<br>     |
|  31|[0x800022f4]<br>0x00000000|- rd : x14<br> - rs1 : f8<br>                                                                                                      |[0x80000438]:fcvt.wu.s a4, fs0, dyn<br> [0x8000043c]:csrrs a7, fflags, zero<br> [0x80000440]:sw a4, 24(a5)<br>     |
|  32|[0x800022fc]<br>0x00000000|- rd : x2<br> - rs1 : f28<br>                                                                                                      |[0x80000450]:fcvt.wu.s sp, ft8, dyn<br> [0x80000454]:csrrs a7, fflags, zero<br> [0x80000458]:sw sp, 32(a5)<br>     |
