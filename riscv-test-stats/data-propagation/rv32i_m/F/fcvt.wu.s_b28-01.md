...
|---:|--------------------------|-----------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|
|   1|[0x80002204]<br>0x00000000|- opcode : fcvt.wu.s<br> - rd : x11<br> - rs1 : f25<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x000000 and rm_val == 0  #nosat<br> |[0x80000120]:fcvt.wu.s a1, fs9, dyn<br> [0x80000124]:csrrs a7, fflags, zero<br> [0x80000128]:sw a1, 0(a5)<br>      |
|   2|[0x8000220c]<br>0x00000000|- rd : x23<br> - rs1 : f3<br> - fs1 == 1 and fe1 == 0xff and fm1 == 0x000000 and rm_val == 0  #nosat<br>                           |[0x80000138]:fcvt.wu.s s7, ft3, dyn<br> [0x8000013c]:csrrs a7, fflags, zero<br> [0x80000140]:sw s7, 8(a5)<br>      |
|   3|[0x80002214]<br>0x00000000|- rd : x29<br> - rs1 : f21<br> - fs1 == 1 and fe1 == 0x9e and fm1 == 0x000000 and rm_val == 0  #nosat<br>                          |[0x80000150]:fcvt.wu.s t4, fs5, dyn<br> [0x80000154]:csrrs a7, fflags, zero<br> [0x80000158]:sw t4, 16(a5)<br>     |
|   4|[0x8000221c]<br>0x00000000|- rd : x0<br> - rs1 : f15<br> - fs1 == 1 and fe1 == 0x9d and fm1 == 0x4b3d25 and rm_val == 0  #nosat<br>                           |[0x80000168]:fcvt.wu.s zero, fa5, dyn<br> [0x8000016c]:csrrs a7, fflags, zero<br> [0x80000170]:sw zero, 24(a5)<br> |
|   5|[0x80002224]<br>0x00000000|- rd : x13<br> - rs1 : f31<br> - fs1 == 1 and fe1 == 0x7f and fm1 == 0x200000 and rm_val == 0  #nosat<br>                          |[0x80000180]:fcvt.wu.s a3, ft11, dyn<br> [0x80000184]:csrrs a7, fflags, zero<br> [0x80000188]:sw a3, 32(a5)<br>    |
|   6|[0x8000222c]<br>0x00000000|- rd : x10<br> - rs1 : f11<br> - fs1 == 1 and fe1 == 0x7f and fm1 == 0x400000 and rm_val == 0  #nosat<br>                          |[0x80000198]:fcvt.wu.s a0, fa1, dyn<br> [0x8000019c]:csrrs a7, fflags, zero<br> [0x800001a0]:sw a0, 40(a5)<br>     |
|   7|[0x80002234]<br>0x00000000|- rd : x2<br> - rs1 : f20<br> - fs1 == 1 and fe1 == 0x7f and fm1 == 0x600000 and rm_val == 0  #nosat<br>                           |[0x800001b0]:fcvt.wu.s sp, fs4, dyn<br> [0x800001b4]:csrrs a7, fflags, zero<br> [0x800001b8]:sw sp, 48(a5)<br>     |
|   8|[0x8000223c]<br>0x00000000|- rd : x6<br> - rs1 : f23<br> - fs1 == 1 and fe1 == 0x80 and fm1 == 0x000000 and rm_val == 0  #nosat<br>                           |[0x800001c8]:fcvt.wu.s t1, fs7, dyn<br> [0x800001cc]:csrrs a7, fflags, zero<br> [0x800001d0]:sw t1, 56(a5)<br>     |
|   9|[0x80002244]<br>0x00000000|- rd : x1<br> - rs1 : f14<br> - fs1 == 1 and fe1 == 0x80 and fm1 == 0x100000 and rm_val == 0  #nosat<br>                           |[0x800001e0]:fcvt.wu.s ra, fa4, dyn<br> [0x800001e4]:csrrs a7, fflags, zero<br> [0x800001e8]:sw ra, 64(a5)<br>     |
|  10|[0x8000224c]<br>0x00000000|- rd : x14<br> - rs1 : f0<br> - fs1 == 1 and fe1 == 0x80 and fm1 == 0x200000 and rm_val == 0  #nosat<br>                           |[0x800001f8]:fcvt.wu.s a4, ft0, dyn<br> [0x800001fc]:csrrs a7, fflags, zero<br> [0x80000200]:sw a4, 72(a5)<br>     |
|  11|[0x80002254]<br>0x00000000|- rd : x4<br> - rs1 : f6<br> - fs1 == 1 and fe1 == 0x80 and fm1 == 0x300000 and rm_val == 0  #nosat<br>                            |[0x80000210]:fcvt.wu.s tp, ft6, dyn<br> [0x80000214]:csrrs a7, fflags, zero<br> [0x80000218]:sw tp, 80(a5)<br>     |
|  12|[0x8000225c]<br>0x00000000|- rd : x21<br> - rs1 : f26<br> - fs1 == 1 and fe1 == 0x7f and fm1 == 0x000000 and rm_val == 0  #nosat<br>                          |[0x80000228]:fcvt.wu.s s5, fs10, dyn<br> [0x8000022c]:csrrs a7, fflags, zero<br> [0x80000230]:sw s5, 88(a5)<br>    |
|  13|[0x80002264]<br>0x00000000|- rd : x28<br> - rs1 : f28<br> - fs1 == 1 and fe1 == 0x7d and fm1 == 0x58046a and rm_val == 0  #nosat<br>                          |[0x80000240]:fcvt.wu.s t3, ft8, dyn<br> [0x80000244]:csrrs a7, fflags, zero<br> [0x80000248]:sw t3, 96(a5)<br>     |
|  14|[0x8000226c]<br>0x00000000|- rd : x8<br> - rs1 : f29<br> - fs1 == 1 and fe1 == 0x00 and fm1 == 0x000000 and rm_val == 0  #nosat<br>                           |[0x80000258]:fcvt.wu.s fp, ft9, dyn<br> [0x8000025c]:csrrs a7, fflags, zero<br> [0x80000260]:sw fp, 104(a5)<br>    |
|  15|[0x80002274]<br>0xFFFFFFFF|- rd : x30<br> - rs1 : f12<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x400001 and rm_val == 0  #nosat<br>                          |[0x80000270]:fcvt.wu.s t5, fa2, dyn<br> [0x80000274]:csrrs a7, fflags, zero<br> [0x80000278]:sw t5, 112(a5)<br>    |
|  16|[0x8000227c]<br>0xFFFFFFFF|- rd : x9<br> - rs1 : f10<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x000001 and rm_val == 0  #nosat<br>                           |[0x80000288]:fcvt.wu.s s1, fa0, dyn<br> [0x8000028c]:csrrs a7, fflags, zero<br> [0x80000290]:sw s1, 120(a5)<br>    |
|  17|[0x80002284]<br>0xFFFFFFFF|- rd : x17<br> - rs1 : f4<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x000000 and rm_val == 0  #nosat<br>                           |[0x800002ac]:fcvt.wu.s a7, ft4, dyn<br> [0x800002b0]:csrrs s5, fflags, zero<br> [0x800002b4]:sw a7, 0(s3)<br>      |
|  18|[0x8000228c]<br>0x7FFFFF80|- rd : x20<br> - rs1 : f18<br> - fs1 == 0 and fe1 == 0x9d and fm1 == 0x7fffff and rm_val == 0  #nosat<br>                          |[0x800002d0]:fcvt.wu.s s4, fs2, dyn<br> [0x800002d4]:csrrs a7, fflags, zero<br> [0x800002d8]:sw s4, 0(a5)<br>      |
|  19|[0x80002294]<br>0x36E5D600|- rd : x26<br> - rs1 : f16<br> - fs1 == 0 and fe1 == 0x9c and fm1 == 0x5b9758 and rm_val == 0  #nosat<br>                          |[0x800002e8]:fcvt.wu.s s10, fa6, dyn<br> [0x800002ec]:csrrs a7, fflags, zero<br> [0x800002f0]:sw s10, 8(a5)<br>    |
|  20|[0x8000229c]<br>0x00000003|- rd : x27<br> - rs1 : f17<br> - fs1 == 0 and fe1 == 0x80 and fm1 == 0x300000 and rm_val == 0  #nosat<br>                          |[0x80000300]:fcvt.wu.s s11, fa7, dyn<br> [0x80000304]:csrrs a7, fflags, zero<br> [0x80000308]:sw s11, 16(a5)<br>   |
|  21|[0x800022a4]<br>0x00000002|- rd : x3<br> - rs1 : f19<br> - fs1 == 0 and fe1 == 0x80 and fm1 == 0x200000 and rm_val == 0  #nosat<br>                           |[0x80000318]:fcvt.wu.s gp, fs3, dyn<br> [0x8000031c]:csrrs a7, fflags, zero<br> [0x80000320]:sw gp, 24(a5)<br>     |
|  22|[0x800022ac]<br>0x00000002|- rd : x25<br> - rs1 : f30<br> - fs1 == 0 and fe1 == 0x80 and fm1 == 0x100000 and rm_val == 0  #nosat<br>                          |[0x80000330]:fcvt.wu.s s9, ft10, dyn<br> [0x80000334]:csrrs a7, fflags, zero<br> [0x80000338]:sw s9, 32(a5)<br>    |
|  23|[0x800022b4]<br>0x00000002|- rd : x12<br> - rs1 : f24<br> - fs1 == 0 and fe1 == 0x80 and fm1 == 0x000000 and rm_val == 0  #nosat<br>                          |[0x80000348]:fcvt.wu.s a2, fs8, dyn<br> [0x8000034c]:csrrs a7, fflags, zero<br> [0x80000350]:sw a2, 40(a5)<br>     |
|  24|[0x800022bc]<br>0x00000002|- rd : x18<br> - rs1 : f27<br> - fs1 == 0 and fe1 == 0x7f and fm1 == 0x600000 and rm_val == 0  #nosat<br>                          |[0x80000360]:fcvt.wu.s s2, fs11, dyn<br> [0x80000364]:csrrs a7, fflags, zero<br> [0x80000368]:sw s2, 48(a5)<br>    |
|  25|[0x800022c4]<br>0x00000002|- rd : x24<br> - rs1 : f13<br> - fs1 == 0 and fe1 == 0x7f and fm1 == 0x400000 and rm_val == 0  #nosat<br>                          |[0x80000378]:fcvt.wu.s s8, fa3, dyn<br> [0x8000037c]:csrrs a7, fflags, zero<br> [0x80000380]:sw s8, 56(a5)<br>     |
|  26|[0x800022cc]<br>0x00000001|- rd : x19<br> - rs1 : f22<br> - fs1 == 0 and fe1 == 0x7f and fm1 == 0x200000 and rm_val == 0  #nosat<br>                          |[0x80000390]:fcvt.wu.s s3, fs6, dyn<br> [0x80000394]:csrrs a7, fflags, zero<br> [0x80000398]:sw s3, 64(a5)<br>     |
|  27|[0x800022d4]<br>0x00000001|- rd : x22<br> - rs1 : f5<br> - fs1 == 0 and fe1 == 0x7f and fm1 == 0x000000 and rm_val == 0  #nosat<br>                           |[0x800003a8]:fcvt.wu.s s6, ft5, dyn<br> [0x800003ac]:csrrs a7, fflags, zero<br> [0x800003b0]:sw s6, 72(a5)<br>     |
|  28|[0x800022dc]<br>0x00000001|- rd : x16<br> - rs1 : f1<br> - fs1 == 0 and fe1 == 0x7e and fm1 == 0x124770 and rm_val == 0  #nosat<br>                           |[0x800003cc]:fcvt.wu.s a6, ft1, dyn<br> [0x800003d0]:csrrs s5, fflags, zero<br> [0x800003d4]:sw a6, 0(s3)<br>      |
|  29|[0x800022e4]<br>0x00000000|- rd : x5<br> - rs1 : f9<br>                                                                                                       |[0x800003f0]:fcvt.wu.s t0, fs1, dyn<br> [0x800003f4]:csrrs a7, fflags, zero<br> [0x800003f8]:sw t0, 0(a5)<br>      |
|  30|[0x800022ec]<br>0x00000000|- rd : x7<br> - rs1 : f2<br>                                                                                                       |[0x80000408]:fcvt.wu.s t2, ft2, dyn<br> [0x8000040c]:csrrs a7, fflags, zero<br> [0x80000410]:sw t2, 8(a5)<br>      |
|  31|[0x800022f4]<br>0x00000000|- rd : x15<br> - rs1 : f8<br>                                                                                                      |[0x8000042c]:fcvt.wu.s a5, fs0, dyn<br> [0x80000430]:csrrs s5, fflags, zero<br> [0x80000434]:sw a5, 0(s3)<br>      |
|  32|[0x800022fc]<br>0x00000000|- rd : x31<br> - rs1 : f7<br>                                                                                                      |[0x80000450]:fcvt.wu.s t6, ft7, dyn<br> [0x80000454]:csrrs a7, fflags, zero<br> [0x80000458]:sw t6, 0(a5)<br>      |
