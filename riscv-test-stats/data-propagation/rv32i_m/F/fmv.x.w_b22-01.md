...
Last Code Sequence : 
	-[0x8000042c]:fmv.x.w a7, fs3
	-[0x80000430]:csrrs s5, fflags, zero
	-[0x80000434]:sw a7, 8(s3)
Current Store : [0x80000438] : sw s5, 12(s3) -- Store: [0x80002300]:0x00000000
...
|---:|--------------------------|-------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------|
|   1|[0x80002204]<br>0x3E4923B8|- opcode : fmv.x.w<br> - rd : x9<br> - rs1 : f3<br> - fs1 == 0 and fe1 == 0x7c and fm1 == 0x4923b8 and rm_val == 0  #nosat<br> |[0x80000120]:fmv.x.w s1, ft3<br> [0x80000124]:csrrs a7, fflags, zero<br> [0x80000128]:sw s1, 0(a5)<br>       |
|   2|[0x8000220c]<br>0x62046756|- rd : x28<br> - rs1 : f8<br> - fs1 == 0 and fe1 == 0xc4 and fm1 == 0x046756 and rm_val == 0  #nosat<br>                       |[0x80000138]:fmv.x.w t3, fs0<br> [0x8000013c]:csrrs a7, fflags, zero<br> [0x80000140]:sw t3, 8(a5)<br>       |
|   3|[0x80002214]<br>0x33D3A4FC|- rd : x21<br> - rs1 : f6<br> - fs1 == 0 and fe1 == 0x67 and fm1 == 0x53a4fc and rm_val == 0  #nosat<br>                       |[0x80000150]:fmv.x.w s5, ft6<br> [0x80000154]:csrrs a7, fflags, zero<br> [0x80000158]:sw s5, 16(a5)<br>      |
|   4|[0x8000221c]<br>0x40E96B5C|- rd : x12<br> - rs1 : f24<br> - fs1 == 0 and fe1 == 0x81 and fm1 == 0x696b5c and rm_val == 0  #nosat<br>                      |[0x80000168]:fmv.x.w a2, fs8<br> [0x8000016c]:csrrs a7, fflags, zero<br> [0x80000170]:sw a2, 24(a5)<br>      |
|   5|[0x80002224]<br>0x40681AE9|- rd : x8<br> - rs1 : f15<br> - fs1 == 0 and fe1 == 0x80 and fm1 == 0x681ae9 and rm_val == 0  #nosat<br>                       |[0x80000180]:fmv.x.w fp, fa5<br> [0x80000184]:csrrs a7, fflags, zero<br> [0x80000188]:sw fp, 32(a5)<br>      |
|   6|[0x8000222c]<br>0x3F9A616D|- rd : x14<br> - rs1 : f20<br> - fs1 == 0 and fe1 == 0x7f and fm1 == 0x1a616d and rm_val == 0  #nosat<br>                      |[0x80000198]:fmv.x.w a4, fs4<br> [0x8000019c]:csrrs a7, fflags, zero<br> [0x800001a0]:sw a4, 40(a5)<br>      |
|   7|[0x80002234]<br>0x3F49FEE5|- rd : x3<br> - rs1 : f12<br> - fs1 == 0 and fe1 == 0x7e and fm1 == 0x49fee5 and rm_val == 0  #nosat<br>                       |[0x800001b0]:fmv.x.w gp, fa2<br> [0x800001b4]:csrrs a7, fflags, zero<br> [0x800001b8]:sw gp, 48(a5)<br>      |
|   8|[0x8000223c]<br>0x3EB6E5D6|- rd : x25<br> - rs1 : f21<br> - fs1 == 0 and fe1 == 0x7d and fm1 == 0x36e5d6 and rm_val == 0  #nosat<br>                      |[0x800001c8]:fmv.x.w s9, fs5<br> [0x800001cc]:csrrs a7, fflags, zero<br> [0x800001d0]:sw s9, 56(a5)<br>      |
|   9|[0x80002244]<br>0x00000000|- rd : x5<br> - rs1 : f27<br>                                                                                                  |[0x800001e0]:fmv.x.w t0, fs11<br> [0x800001e4]:csrrs a7, fflags, zero<br> [0x800001e8]:sw t0, 64(a5)<br>     |
|  10|[0x8000224c]<br>0x00000000|- rd : x4<br> - rs1 : f26<br>                                                                                                  |[0x800001f8]:fmv.x.w tp, fs10<br> [0x800001fc]:csrrs a7, fflags, zero<br> [0x80000200]:sw tp, 72(a5)<br>     |
|  11|[0x80002254]<br>0x00000000|- rd : x26<br> - rs1 : f25<br>                                                                                                 |[0x80000210]:fmv.x.w s10, fs9<br> [0x80000214]:csrrs a7, fflags, zero<br> [0x80000218]:sw s10, 80(a5)<br>    |
|  12|[0x8000225c]<br>0x00000000|- rd : x11<br> - rs1 : f16<br>                                                                                                 |[0x80000228]:fmv.x.w a1, fa6<br> [0x8000022c]:csrrs a7, fflags, zero<br> [0x80000230]:sw a1, 88(a5)<br>      |
|  13|[0x80002264]<br>0x00000000|- rd : x10<br> - rs1 : f22<br>                                                                                                 |[0x80000240]:fmv.x.w a0, fs6<br> [0x80000244]:csrrs a7, fflags, zero<br> [0x80000248]:sw a0, 96(a5)<br>      |
|  14|[0x8000226c]<br>0x00000000|- rd : x24<br> - rs1 : f14<br>                                                                                                 |[0x80000258]:fmv.x.w s8, fa4<br> [0x8000025c]:csrrs a7, fflags, zero<br> [0x80000260]:sw s8, 104(a5)<br>     |
|  15|[0x80002274]<br>0x00000000|- rd : x29<br> - rs1 : f29<br>                                                                                                 |[0x80000270]:fmv.x.w t4, ft9<br> [0x80000274]:csrrs a7, fflags, zero<br> [0x80000278]:sw t4, 112(a5)<br>     |
|  16|[0x8000227c]<br>0x00000000|- rd : x27<br> - rs1 : f2<br>                                                                                                  |[0x80000288]:fmv.x.w s11, ft2<br> [0x8000028c]:csrrs a7, fflags, zero<br> [0x80000290]:sw s11, 120(a5)<br>   |
|  17|[0x80002284]<br>0x00000000|- rd : x2<br> - rs1 : f10<br>                                                                                                  |[0x800002a0]:fmv.x.w sp, fa0<br> [0x800002a4]:csrrs a7, fflags, zero<br> [0x800002a8]:sw sp, 128(a5)<br>     |
|  18|[0x8000228c]<br>0x00000000|- rd : x1<br> - rs1 : f23<br>                                                                                                  |[0x800002b8]:fmv.x.w ra, fs7<br> [0x800002bc]:csrrs a7, fflags, zero<br> [0x800002c0]:sw ra, 136(a5)<br>     |
|  19|[0x80002294]<br>0x00000000|- rd : x30<br> - rs1 : f1<br>                                                                                                  |[0x800002d0]:fmv.x.w t5, ft1<br> [0x800002d4]:csrrs a7, fflags, zero<br> [0x800002d8]:sw t5, 144(a5)<br>     |
|  20|[0x8000229c]<br>0x00000000|- rd : x6<br> - rs1 : f9<br>                                                                                                   |[0x800002e8]:fmv.x.w t1, fs1<br> [0x800002ec]:csrrs a7, fflags, zero<br> [0x800002f0]:sw t1, 152(a5)<br>     |
|  21|[0x800022a4]<br>0x00000000|- rd : x23<br> - rs1 : f13<br>                                                                                                 |[0x80000300]:fmv.x.w s7, fa3<br> [0x80000304]:csrrs a7, fflags, zero<br> [0x80000308]:sw s7, 160(a5)<br>     |
|  22|[0x800022ac]<br>0x00000000|- rd : x7<br> - rs1 : f4<br>                                                                                                   |[0x80000318]:fmv.x.w t2, ft4<br> [0x8000031c]:csrrs a7, fflags, zero<br> [0x80000320]:sw t2, 168(a5)<br>     |
|  23|[0x800022b4]<br>0x00000000|- rd : x18<br> - rs1 : f28<br>                                                                                                 |[0x80000330]:fmv.x.w s2, ft8<br> [0x80000334]:csrrs a7, fflags, zero<br> [0x80000338]:sw s2, 176(a5)<br>     |
|  24|[0x800022bc]<br>0x00000000|- rd : x0<br> - rs1 : f11<br>                                                                                                  |[0x80000348]:fmv.x.w zero, fa1<br> [0x8000034c]:csrrs a7, fflags, zero<br> [0x80000350]:sw zero, 184(a5)<br> |
|  25|[0x800022c4]<br>0x00000000|- rd : x19<br> - rs1 : f17<br>                                                                                                 |[0x80000360]:fmv.x.w s3, fa7<br> [0x80000364]:csrrs a7, fflags, zero<br> [0x80000368]:sw s3, 192(a5)<br>     |
|  26|[0x800022cc]<br>0x00000000|- rd : x15<br> - rs1 : f18<br>                                                                                                 |[0x80000384]:fmv.x.w a5, fs2<br> [0x80000388]:csrrs s5, fflags, zero<br> [0x8000038c]:sw a5, 0(s3)<br>       |
|  27|[0x800022d4]<br>0x00000000|- rd : x22<br> - rs1 : f0<br>                                                                                                  |[0x800003a8]:fmv.x.w s6, ft0<br> [0x800003ac]:csrrs a7, fflags, zero<br> [0x800003b0]:sw s6, 0(a5)<br>       |
|  28|[0x800022dc]<br>0x00000000|- rd : x13<br> - rs1 : f7<br>                                                                                                  |[0x800003c0]:fmv.x.w a3, ft7<br> [0x800003c4]:csrrs a7, fflags, zero<br> [0x800003c8]:sw a3, 8(a5)<br>       |
|  29|[0x800022e4]<br>0x00000000|- rd : x20<br> - rs1 : f31<br>                                                                                                 |[0x800003d8]:fmv.x.w s4, ft11<br> [0x800003dc]:csrrs a7, fflags, zero<br> [0x800003e0]:sw s4, 16(a5)<br>     |
|  30|[0x800022ec]<br>0x00000000|- rd : x31<br> - rs1 : f30<br>                                                                                                 |[0x800003f0]:fmv.x.w t6, ft10<br> [0x800003f4]:csrrs a7, fflags, zero<br> [0x800003f8]:sw t6, 24(a5)<br>     |
|  31|[0x800022f4]<br>0x00000000|- rd : x16<br> - rs1 : f5<br>                                                                                                  |[0x80000414]:fmv.x.w a6, ft5<br> [0x80000418]:csrrs s5, fflags, zero<br> [0x8000041c]:sw a6, 0(s3)<br>       |
|  32|[0x800022fc]<br>0x00000000|- rd : x17<br> - rs1 : f19<br>                                                                                                 |[0x8000042c]:fmv.x.w a7, fs3<br> [0x80000430]:csrrs s5, fflags, zero<br> [0x80000434]:sw a7, 8(s3)<br>       |
