...
|---:|--------------------------|--------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------|
|   1|[0x80002204]<br>0x00000000|- opcode : fcvt.w.s<br> - rd : x9<br> - rs1 : f7<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x000000 and rm_val == 0  #nosat<br> |[0x80000120]:fcvt.w.s s1, ft7, dyn<br> [0x80000124]:csrrs a7, fflags, zero<br> [0x80000128]:sw s1, 0(a5)<br>      |
|   2|[0x8000220c]<br>0x80000000|- rd : x23<br> - rs1 : f25<br> - fs1 == 1 and fe1 == 0xff and fm1 == 0x000000 and rm_val == 0  #nosat<br>                       |[0x80000138]:fcvt.w.s s7, fs9, dyn<br> [0x8000013c]:csrrs a7, fflags, zero<br> [0x80000140]:sw s7, 8(a5)<br>      |
|   3|[0x80002214]<br>0x80000000|- rd : x6<br> - rs1 : f9<br> - fs1 == 1 and fe1 == 0x9e and fm1 == 0x000000 and rm_val == 0  #nosat<br>                         |[0x80000150]:fcvt.w.s t1, fs1, dyn<br> [0x80000154]:csrrs a7, fflags, zero<br> [0x80000158]:sw t1, 16(a5)<br>     |
|   4|[0x8000221c]<br>0x9A616D80|- rd : x14<br> - rs1 : f20<br> - fs1 == 1 and fe1 == 0x9d and fm1 == 0x4b3d25 and rm_val == 0  #nosat<br>                       |[0x80000168]:fcvt.w.s a4, fs4, dyn<br> [0x8000016c]:csrrs a7, fflags, zero<br> [0x80000170]:sw a4, 24(a5)<br>     |
|   5|[0x80002224]<br>0xFFFFFFFF|- rd : x2<br> - rs1 : f15<br> - fs1 == 1 and fe1 == 0x7f and fm1 == 0x200000 and rm_val == 0  #nosat<br>                        |[0x80000180]:fcvt.w.s sp, fa5, dyn<br> [0x80000184]:csrrs a7, fflags, zero<br> [0x80000188]:sw sp, 32(a5)<br>     |
|   6|[0x8000222c]<br>0xFFFFFFFE|- rd : x24<br> - rs1 : f27<br> - fs1 == 1 and fe1 == 0x7f and fm1 == 0x400000 and rm_val == 0  #nosat<br>                       |[0x80000198]:fcvt.w.s s8, fs11, dyn<br> [0x8000019c]:csrrs a7, fflags, zero<br> [0x800001a0]:sw s8, 40(a5)<br>    |
|   7|[0x80002234]<br>0xFFFFFFFE|- rd : x20<br> - rs1 : f19<br> - fs1 == 1 and fe1 == 0x7f and fm1 == 0x600000 and rm_val == 0  #nosat<br>                       |[0x800001b0]:fcvt.w.s s4, fs3, dyn<br> [0x800001b4]:csrrs a7, fflags, zero<br> [0x800001b8]:sw s4, 48(a5)<br>     |
|   8|[0x8000223c]<br>0xFFFFFFFE|- rd : x30<br> - rs1 : f23<br> - fs1 == 1 and fe1 == 0x80 and fm1 == 0x000000 and rm_val == 0  #nosat<br>                       |[0x800001c8]:fcvt.w.s t5, fs7, dyn<br> [0x800001cc]:csrrs a7, fflags, zero<br> [0x800001d0]:sw t5, 56(a5)<br>     |
|   9|[0x80002244]<br>0x00000000|- rd : x0<br> - rs1 : f1<br> - fs1 == 1 and fe1 == 0x80 and fm1 == 0x100000 and rm_val == 0  #nosat<br>                         |[0x800001e0]:fcvt.w.s zero, ft1, dyn<br> [0x800001e4]:csrrs a7, fflags, zero<br> [0x800001e8]:sw zero, 64(a5)<br> |
|  10|[0x8000224c]<br>0xFFFFFFFE|- rd : x27<br> - rs1 : f6<br> - fs1 == 1 and fe1 == 0x80 and fm1 == 0x200000 and rm_val == 0  #nosat<br>                        |[0x800001f8]:fcvt.w.s s11, ft6, dyn<br> [0x800001fc]:csrrs a7, fflags, zero<br> [0x80000200]:sw s11, 72(a5)<br>   |
|  11|[0x80002254]<br>0xFFFFFFFD|- rd : x16<br> - rs1 : f18<br> - fs1 == 1 and fe1 == 0x80 and fm1 == 0x300000 and rm_val == 0  #nosat<br>                       |[0x8000021c]:fcvt.w.s a6, fs2, dyn<br> [0x80000220]:csrrs s5, fflags, zero<br> [0x80000224]:sw a6, 0(s3)<br>      |
|  12|[0x8000225c]<br>0xFFFFFFFF|- rd : x31<br> - rs1 : f16<br> - fs1 == 1 and fe1 == 0x7f and fm1 == 0x000000 and rm_val == 0  #nosat<br>                       |[0x80000240]:fcvt.w.s t6, fa6, dyn<br> [0x80000244]:csrrs a7, fflags, zero<br> [0x80000248]:sw t6, 0(a5)<br>      |
|  13|[0x80002264]<br>0x00000000|- rd : x22<br> - rs1 : f22<br> - fs1 == 1 and fe1 == 0x7d and fm1 == 0x58046a and rm_val == 0  #nosat<br>                       |[0x80000258]:fcvt.w.s s6, fs6, dyn<br> [0x8000025c]:csrrs a7, fflags, zero<br> [0x80000260]:sw s6, 8(a5)<br>      |
|  14|[0x8000226c]<br>0x00000000|- rd : x8<br> - rs1 : f14<br> - fs1 == 1 and fe1 == 0x00 and fm1 == 0x000000 and rm_val == 0  #nosat<br>                        |[0x80000270]:fcvt.w.s fp, fa4, dyn<br> [0x80000274]:csrrs a7, fflags, zero<br> [0x80000278]:sw fp, 16(a5)<br>     |
|  15|[0x80002274]<br>0x7FFFFFFF|- rd : x17<br> - rs1 : f12<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x400001 and rm_val == 0  #nosat<br>                       |[0x80000294]:fcvt.w.s a7, fa2, dyn<br> [0x80000298]:csrrs s5, fflags, zero<br> [0x8000029c]:sw a7, 0(s3)<br>      |
|  16|[0x8000227c]<br>0x7FFFFFFF|- rd : x13<br> - rs1 : f8<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x000001 and rm_val == 0  #nosat<br>                        |[0x800002b8]:fcvt.w.s a3, fs0, dyn<br> [0x800002bc]:csrrs a7, fflags, zero<br> [0x800002c0]:sw a3, 0(a5)<br>      |
|  17|[0x80002284]<br>0x7FFFFFFF|- rd : x7<br> - rs1 : f21<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x000000 and rm_val == 0  #nosat<br>                        |[0x800002d0]:fcvt.w.s t2, fs5, dyn<br> [0x800002d4]:csrrs a7, fflags, zero<br> [0x800002d8]:sw t2, 8(a5)<br>      |
|  18|[0x8000228c]<br>0x7FFFFF80|- rd : x4<br> - rs1 : f13<br> - fs1 == 0 and fe1 == 0x9d and fm1 == 0x7fffff and rm_val == 0  #nosat<br>                        |[0x800002e8]:fcvt.w.s tp, fa3, dyn<br> [0x800002ec]:csrrs a7, fflags, zero<br> [0x800002f0]:sw tp, 16(a5)<br>     |
|  19|[0x80002294]<br>0x36E5D600|- rd : x10<br> - rs1 : f10<br> - fs1 == 0 and fe1 == 0x9c and fm1 == 0x5b9758 and rm_val == 0  #nosat<br>                       |[0x80000300]:fcvt.w.s a0, fa0, dyn<br> [0x80000304]:csrrs a7, fflags, zero<br> [0x80000308]:sw a0, 24(a5)<br>     |
|  20|[0x8000229c]<br>0x00000003|- rd : x3<br> - rs1 : f5<br> - fs1 == 0 and fe1 == 0x80 and fm1 == 0x300000 and rm_val == 0  #nosat<br>                         |[0x80000318]:fcvt.w.s gp, ft5, dyn<br> [0x8000031c]:csrrs a7, fflags, zero<br> [0x80000320]:sw gp, 32(a5)<br>     |
|  21|[0x800022a4]<br>0x00000002|- rd : x1<br> - rs1 : f24<br> - fs1 == 0 and fe1 == 0x80 and fm1 == 0x200000 and rm_val == 0  #nosat<br>                        |[0x80000330]:fcvt.w.s ra, fs8, dyn<br> [0x80000334]:csrrs a7, fflags, zero<br> [0x80000338]:sw ra, 40(a5)<br>     |
|  22|[0x800022ac]<br>0x00000002|- rd : x28<br> - rs1 : f26<br> - fs1 == 0 and fe1 == 0x80 and fm1 == 0x100000 and rm_val == 0  #nosat<br>                       |[0x80000348]:fcvt.w.s t3, fs10, dyn<br> [0x8000034c]:csrrs a7, fflags, zero<br> [0x80000350]:sw t3, 48(a5)<br>    |
|  23|[0x800022b4]<br>0x00000002|- rd : x11<br> - rs1 : f4<br> - fs1 == 0 and fe1 == 0x80 and fm1 == 0x000000 and rm_val == 0  #nosat<br>                        |[0x80000360]:fcvt.w.s a1, ft4, dyn<br> [0x80000364]:csrrs a7, fflags, zero<br> [0x80000368]:sw a1, 56(a5)<br>     |
|  24|[0x800022bc]<br>0x00000002|- rd : x19<br> - rs1 : f31<br> - fs1 == 0 and fe1 == 0x7f and fm1 == 0x600000 and rm_val == 0  #nosat<br>                       |[0x80000378]:fcvt.w.s s3, ft11, dyn<br> [0x8000037c]:csrrs a7, fflags, zero<br> [0x80000380]:sw s3, 64(a5)<br>    |
|  25|[0x800022c4]<br>0x00000002|- rd : x29<br> - rs1 : f17<br> - fs1 == 0 and fe1 == 0x7f and fm1 == 0x400000 and rm_val == 0  #nosat<br>                       |[0x80000390]:fcvt.w.s t4, fa7, dyn<br> [0x80000394]:csrrs a7, fflags, zero<br> [0x80000398]:sw t4, 72(a5)<br>     |
|  26|[0x800022cc]<br>0x00000001|- rd : x12<br> - rs1 : f2<br> - fs1 == 0 and fe1 == 0x7f and fm1 == 0x200000 and rm_val == 0  #nosat<br>                        |[0x800003a8]:fcvt.w.s a2, ft2, dyn<br> [0x800003ac]:csrrs a7, fflags, zero<br> [0x800003b0]:sw a2, 80(a5)<br>     |
|  27|[0x800022d4]<br>0x00000001|- rd : x5<br> - rs1 : f30<br> - fs1 == 0 and fe1 == 0x7f and fm1 == 0x000000 and rm_val == 0  #nosat<br>                        |[0x800003c0]:fcvt.w.s t0, ft10, dyn<br> [0x800003c4]:csrrs a7, fflags, zero<br> [0x800003c8]:sw t0, 88(a5)<br>    |
|  28|[0x800022dc]<br>0x00000001|- rd : x15<br> - rs1 : f11<br> - fs1 == 0 and fe1 == 0x7e and fm1 == 0x124770 and rm_val == 0  #nosat<br>                       |[0x800003e4]:fcvt.w.s a5, fa1, dyn<br> [0x800003e8]:csrrs s5, fflags, zero<br> [0x800003ec]:sw a5, 0(s3)<br>      |
|  29|[0x800022e4]<br>0x00000000|- rd : x21<br> - rs1 : f29<br>                                                                                                  |[0x80000408]:fcvt.w.s s5, ft9, dyn<br> [0x8000040c]:csrrs a7, fflags, zero<br> [0x80000410]:sw s5, 0(a5)<br>      |
|  30|[0x800022ec]<br>0x00000000|- rd : x26<br> - rs1 : f28<br>                                                                                                  |[0x80000420]:fcvt.w.s s10, ft8, dyn<br> [0x80000424]:csrrs a7, fflags, zero<br> [0x80000428]:sw s10, 8(a5)<br>    |
|  31|[0x800022f4]<br>0x00000000|- rd : x18<br> - rs1 : f3<br>                                                                                                   |[0x80000438]:fcvt.w.s s2, ft3, dyn<br> [0x8000043c]:csrrs a7, fflags, zero<br> [0x80000440]:sw s2, 16(a5)<br>     |
|  32|[0x800022fc]<br>0x00000000|- rd : x25<br> - rs1 : f0<br>                                                                                                   |[0x80000450]:fcvt.w.s s9, ft0, dyn<br> [0x80000454]:csrrs a7, fflags, zero<br> [0x80000458]:sw s9, 24(a5)<br>     |
