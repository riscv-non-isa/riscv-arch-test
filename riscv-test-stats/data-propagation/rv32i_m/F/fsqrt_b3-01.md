...
Last Coverpoint : ['rs1 : f15', 'rd : f11']
Last Code Sequence : 
	-[0x800003f0]:fsqrt.s fa1, fa5, dyn
	-[0x800003f4]:csrrs a7, fflags, zero
	-[0x800003f8]:fsw fa1, 240(a5)
Current Store : [0x800003fc] : sw a7, 244(a5) -- Store: [0x800022f8]:0x00000000




Last Coverpoint : ['rs1 : f11', 'rd : f1']
Last Code Sequence : 
	-[0x80000408]:fsqrt.s ft1, fa1, dyn
	-[0x8000040c]:csrrs a7, fflags, zero
	-[0x80000410]:fsw ft1, 248(a5)
...
|---:|--------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------|
|   1|[0x80002204]<br>0xF56FF76D|- opcode : fsqrt.s<br> - rs1 : f14<br> - rd : f14<br> - rs1 == rd<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x000000 and rm_val == 0  #nosat<br> |[0x80000120]:fsqrt.s fa4, fa4, dyn<br> [0x80000124]:csrrs a7, fflags, zero<br> [0x80000128]:fsw fa4, 0(a5)<br>      |
|   2|[0x8000220c]<br>0xBFDDB7D5|- rs1 : f30<br> - rd : f4<br> - rs1 != rd<br> - fs1 == 0 and fe1 == 0x29 and fm1 == 0x000000 and rm_val == 4  #nosat<br>                         |[0x80000138]:fsqrt.s ft4, ft10, dyn<br> [0x8000013c]:csrrs a7, fflags, zero<br> [0x80000140]:fsw ft4, 8(a5)<br>     |
|   3|[0x80002214]<br>0xEEDBEADF|- rs1 : f9<br> - rd : f29<br> - fs1 == 0 and fe1 == 0x29 and fm1 == 0x000000 and rm_val == 3  #nosat<br>                                         |[0x80000150]:fsqrt.s ft9, fs1, dyn<br> [0x80000154]:csrrs a7, fflags, zero<br> [0x80000158]:fsw ft9, 16(a5)<br>     |
|   4|[0x8000221c]<br>0x5BFDDB7D|- rs1 : f1<br> - rd : f8<br> - fs1 == 0 and fe1 == 0x29 and fm1 == 0x000000 and rm_val == 2  #nosat<br>                                          |[0x80000168]:fsqrt.s fs0, ft1, dyn<br> [0x8000016c]:csrrs a7, fflags, zero<br> [0x80000170]:fsw fs0, 24(a5)<br>     |
|   5|[0x80002224]<br>0xB7FBB6FA|- rs1 : f5<br> - rd : f7<br> - fs1 == 0 and fe1 == 0x29 and fm1 == 0x000000 and rm_val == 1  #nosat<br>                                          |[0x80000180]:fsqrt.s ft7, ft5, dyn<br> [0x80000184]:csrrs a7, fflags, zero<br> [0x80000188]:fsw ft7, 32(a5)<br>     |
|   6|[0x8000222c]<br>0x6DF56FF7|- rs1 : f31<br> - rd : f22<br> - fs1 == 0 and fe1 == 0x29 and fm1 == 0x000000 and rm_val == 0  #nosat<br>                                        |[0x80000198]:fsqrt.s fs6, ft11, dyn<br> [0x8000019c]:csrrs a7, fflags, zero<br> [0x800001a0]:fsw fs6, 40(a5)<br>    |
|   7|[0x80002234]<br>0xEDBEADFE|- rs1 : f6<br> - rd : f25<br> - fs1 == 0 and fe1 == 0xd5 and fm1 == 0x000000 and rm_val == 4  #nosat<br>                                         |[0x800001b0]:fsqrt.s fs9, ft6, dyn<br> [0x800001b4]:csrrs a7, fflags, zero<br> [0x800001b8]:fsw fs9, 48(a5)<br>     |
|   8|[0x8000223c]<br>0xDBEADFEE|- rs1 : f17<br> - rd : f21<br> - fs1 == 0 and fe1 == 0xd5 and fm1 == 0x000000 and rm_val == 3  #nosat<br>                                        |[0x800001c8]:fsqrt.s fs5, fa7, dyn<br> [0x800001cc]:csrrs a7, fflags, zero<br> [0x800001d0]:fsw fs5, 56(a5)<br>     |
|   9|[0x80002244]<br>0xDF56FF76|- rs1 : f20<br> - rd : f18<br> - fs1 == 0 and fe1 == 0xd5 and fm1 == 0x000000 and rm_val == 2  #nosat<br>                                        |[0x800001e0]:fsqrt.s fs2, fs4, dyn<br> [0x800001e4]:csrrs a7, fflags, zero<br> [0x800001e8]:fsw fs2, 64(a5)<br>     |
|  10|[0x8000224c]<br>0x80002004|- rs1 : f25<br> - rd : f16<br> - fs1 == 0 and fe1 == 0xd5 and fm1 == 0x000000 and rm_val == 1  #nosat<br>                                        |[0x800001f8]:fsqrt.s fa6, fs9, dyn<br> [0x800001fc]:csrrs a7, fflags, zero<br> [0x80000200]:fsw fa6, 72(a5)<br>     |
|  11|[0x80002254]<br>0xD5BFDDB7|- rs1 : f13<br> - rd : f12<br> - fs1 == 0 and fe1 == 0xd5 and fm1 == 0x000000 and rm_val == 0  #nosat<br>                                        |[0x80000210]:fsqrt.s fa2, fa3, dyn<br> [0x80000214]:csrrs a7, fflags, zero<br> [0x80000218]:fsw fa2, 80(a5)<br>     |
|  12|[0x8000225c]<br>0x00000000|- rs1 : f22<br> - rd : f0<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x000000 and rm_val == 4  #nosat<br>                                         |[0x80000228]:fsqrt.s ft0, fs6, dyn<br> [0x8000022c]:csrrs a7, fflags, zero<br> [0x80000230]:fsw ft0, 88(a5)<br>     |
|  13|[0x80002264]<br>0x76DF56FF|- rs1 : f21<br> - rd : f26<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x000000 and rm_val == 3  #nosat<br>                                        |[0x80000240]:fsqrt.s fs10, fs5, dyn<br> [0x80000244]:csrrs a7, fflags, zero<br> [0x80000248]:fsw fs10, 96(a5)<br>   |
|  14|[0x8000226c]<br>0x800000F8|- rs1 : f8<br> - rd : f5<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x000000 and rm_val == 2  #nosat<br>                                          |[0x80000258]:fsqrt.s ft5, fs0, dyn<br> [0x8000025c]:csrrs a7, fflags, zero<br> [0x80000260]:fsw ft5, 104(a5)<br>    |
|  15|[0x80002274]<br>0x80002204|- rs1 : f0<br> - rd : f15<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x000000 and rm_val == 1  #nosat<br>                                         |[0x80000270]:fsqrt.s fa5, ft0, dyn<br> [0x80000274]:csrrs a7, fflags, zero<br> [0x80000278]:fsw fa5, 112(a5)<br>    |
|  16|[0x8000227c]<br>0x6FAB7FBB|- rs1 : f7<br> - rd : f19<br>                                                                                                                    |[0x80000288]:fsqrt.s fs3, ft7, dyn<br> [0x8000028c]:csrrs a7, fflags, zero<br> [0x80000290]:fsw fs3, 120(a5)<br>    |
|  17|[0x80002284]<br>0xDB7D5BFD|- rs1 : f27<br> - rd : f24<br>                                                                                                                   |[0x800002a0]:fsqrt.s fs8, fs11, dyn<br> [0x800002a4]:csrrs a7, fflags, zero<br> [0x800002a8]:fsw fs8, 128(a5)<br>   |
|  18|[0x8000228c]<br>0x56FF76DF|- rs1 : f2<br> - rd : f10<br>                                                                                                                    |[0x800002b8]:fsqrt.s fa0, ft2, dyn<br> [0x800002bc]:csrrs a7, fflags, zero<br> [0x800002c0]:fsw fa0, 136(a5)<br>    |
|  19|[0x80002294]<br>0xBB6FAB7F|- rs1 : f10<br> - rd : f27<br>                                                                                                                   |[0x800002d0]:fsqrt.s fs11, fa0, dyn<br> [0x800002d4]:csrrs a7, fflags, zero<br> [0x800002d8]:fsw fs11, 144(a5)<br>  |
|  20|[0x8000229c]<br>0xF76DF56F|- rs1 : f26<br> - rd : f30<br>                                                                                                                   |[0x800002e8]:fsqrt.s ft10, fs10, dyn<br> [0x800002ec]:csrrs a7, fflags, zero<br> [0x800002f0]:fsw ft10, 152(a5)<br> |
|  21|[0x800022a4]<br>0xB7D5BFDD|- rs1 : f18<br> - rd : f20<br>                                                                                                                   |[0x80000300]:fsqrt.s fs4, fs2, dyn<br> [0x80000304]:csrrs a7, fflags, zero<br> [0x80000308]:fsw fs4, 160(a5)<br>    |
|  22|[0x800022ac]<br>0xDDB7D5BF|- rs1 : f12<br> - rd : f28<br>                                                                                                                   |[0x80000318]:fsqrt.s ft8, fa2, dyn<br> [0x8000031c]:csrrs a7, fflags, zero<br> [0x80000320]:fsw ft8, 168(a5)<br>    |
|  23|[0x800022b4]<br>0x00006000|- rs1 : f29<br> - rd : f2<br>                                                                                                                    |[0x80000330]:fsqrt.s ft2, ft9, dyn<br> [0x80000334]:csrrs a7, fflags, zero<br> [0x80000338]:fsw ft2, 176(a5)<br>    |
|  24|[0x800022bc]<br>0xFBB6FAB7|- rs1 : f16<br> - rd : f31<br>                                                                                                                   |[0x80000348]:fsqrt.s ft11, fa6, dyn<br> [0x8000034c]:csrrs a7, fflags, zero<br> [0x80000350]:fsw ft11, 184(a5)<br>  |
|  25|[0x800022c4]<br>0xEADFEEDB|- rs1 : f28<br> - rd : f13<br>                                                                                                                   |[0x80000360]:fsqrt.s fa3, ft8, dyn<br> [0x80000364]:csrrs a7, fflags, zero<br> [0x80000368]:fsw fa3, 192(a5)<br>    |
|  26|[0x800022cc]<br>0x80002000|- rs1 : f19<br> - rd : f6<br>                                                                                                                    |[0x80000378]:fsqrt.s ft6, fs3, dyn<br> [0x8000037c]:csrrs a7, fflags, zero<br> [0x80000380]:fsw ft6, 200(a5)<br>    |
|  27|[0x800022d4]<br>0x00000000|- rs1 : f23<br> - rd : f17<br>                                                                                                                   |[0x80000390]:fsqrt.s fa7, fs7, dyn<br> [0x80000394]:csrrs a7, fflags, zero<br> [0x80000398]:fsw fa7, 208(a5)<br>    |
|  28|[0x800022dc]<br>0xB6FAB7FB|- rs1 : f3<br> - rd : f23<br>                                                                                                                    |[0x800003a8]:fsqrt.s fs7, ft3, dyn<br> [0x800003ac]:csrrs a7, fflags, zero<br> [0x800003b0]:fsw fs7, 216(a5)<br>    |
|  29|[0x800022e4]<br>0xADFEEDBE|- rs1 : f4<br> - rd : f9<br>                                                                                                                     |[0x800003c0]:fsqrt.s fs1, ft4, dyn<br> [0x800003c4]:csrrs a7, fflags, zero<br> [0x800003c8]:fsw fs1, 224(a5)<br>    |
