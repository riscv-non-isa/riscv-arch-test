...
|---:|--------------------------|--------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------|
|   1|[0x80002204]<br>0xBF800000|- opcode : fmv.x.w<br> - rd : x3<br> - rs1 : f17<br> - fs1 == 1 and fe1 == 0x7f and fm1 == 0x000000 and rm_val == 0  #nosat<br> |[0x80000120]:fmv.x.w gp, fa7<br> [0x80000124]:csrrs a7, fflags, zero<br> [0x80000128]:sw gp, 0(a5)<br>       |
|   2|[0x8000220c]<br>0xBF63D70A|- rd : x24<br> - rs1 : f29<br> - fs1 == 1 and fe1 == 0x7e and fm1 == 0x63d70a and rm_val == 0  #nosat<br>                       |[0x80000138]:fmv.x.w s8, ft9<br> [0x8000013c]:csrrs a7, fflags, zero<br> [0x80000140]:sw s8, 8(a5)<br>       |
|   3|[0x80002214]<br>0x3F8E147A|- rd : x27<br> - rs1 : f20<br> - fs1 == 0 and fe1 == 0x7f and fm1 == 0x0e147a and rm_val == 0  #nosat<br>                       |[0x80000150]:fmv.x.w s11, fs4<br> [0x80000154]:csrrs a7, fflags, zero<br> [0x80000158]:sw s11, 16(a5)<br>    |
|   4|[0x8000221c]<br>0x3DCCCCCC|- rd : x10<br> - rs1 : f5<br> - fs1 == 0 and fe1 == 0x7b and fm1 == 0x4ccccc and rm_val == 0  #nosat<br>                        |[0x80000168]:fmv.x.w a0, ft5<br> [0x8000016c]:csrrs a7, fflags, zero<br> [0x80000170]:sw a0, 24(a5)<br>      |
|   5|[0x80002224]<br>0x00000000|- rd : x0<br> - rs1 : f31<br> - fs1 == 0 and fe1 == 0x7f and fm1 == 0x0147ae and rm_val == 0  #nosat<br>                        |[0x80000180]:fmv.x.w zero, ft11<br> [0x80000184]:csrrs a7, fflags, zero<br> [0x80000188]:sw zero, 32(a5)<br> |
|   6|[0x8000222c]<br>0x000007F0|- rd : x17<br> - rs1 : f28<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x0007f0 and rm_val == 0  #nosat<br>                       |[0x800001a4]:fmv.x.w a7, ft8<br> [0x800001a8]:csrrs s5, fflags, zero<br> [0x800001ac]:sw a7, 0(s3)<br>       |
|   7|[0x80002234]<br>0x3F800000|- rd : x11<br> - rs1 : f3<br> - fs1 == 0 and fe1 == 0x7f and fm1 == 0x000000 and rm_val == 0  #nosat<br>                        |[0x800001c8]:fmv.x.w a1, ft3<br> [0x800001cc]:csrrs a7, fflags, zero<br> [0x800001d0]:sw a1, 0(a5)<br>       |
|   8|[0x8000223c]<br>0xBF7D70A3|- rd : x28<br> - rs1 : f24<br> - fs1 == 1 and fe1 == 0x7e and fm1 == 0x7d70a3 and rm_val == 0  #nosat<br>                       |[0x800001e0]:fmv.x.w t3, fs8<br> [0x800001e4]:csrrs a7, fflags, zero<br> [0x800001e8]:sw t3, 8(a5)<br>       |
|   9|[0x80002244]<br>0x3DE147AE|- rd : x4<br> - rs1 : f26<br> - fs1 == 0 and fe1 == 0x7b and fm1 == 0x6147ae and rm_val == 0  #nosat<br>                        |[0x800001f8]:fmv.x.w tp, fs10<br> [0x800001fc]:csrrs a7, fflags, zero<br> [0x80000200]:sw tp, 16(a5)<br>     |
|  10|[0x8000224c]<br>0xBF8E147A|- rd : x14<br> - rs1 : f11<br> - fs1 == 1 and fe1 == 0x7f and fm1 == 0x0e147a and rm_val == 0  #nosat<br>                       |[0x80000210]:fmv.x.w a4, fa1<br> [0x80000214]:csrrs a7, fflags, zero<br> [0x80000218]:sw a4, 24(a5)<br>      |
|  11|[0x80002254]<br>0xBF666666|- rd : x31<br> - rs1 : f8<br> - fs1 == 1 and fe1 == 0x7e and fm1 == 0x666666 and rm_val == 0  #nosat<br>                        |[0x80000228]:fmv.x.w t6, fs0<br> [0x8000022c]:csrrs a7, fflags, zero<br> [0x80000230]:sw t6, 32(a5)<br>      |
|  12|[0x8000225c]<br>0xBF8147AE|- rd : x29<br> - rs1 : f15<br> - fs1 == 1 and fe1 == 0x7f and fm1 == 0x0147ae and rm_val == 0  #nosat<br>                       |[0x80000240]:fmv.x.w t4, fa5<br> [0x80000244]:csrrs a7, fflags, zero<br> [0x80000248]:sw t4, 40(a5)<br>      |
|  13|[0x80002264]<br>0xBDCCCCCC|- rd : x16<br> - rs1 : f7<br> - fs1 == 1 and fe1 == 0x7b and fm1 == 0x4ccccc and rm_val == 0  #nosat<br>                        |[0x80000264]:fmv.x.w a6, ft7<br> [0x80000268]:csrrs s5, fflags, zero<br> [0x8000026c]:sw a6, 0(s3)<br>       |
|  14|[0x8000226c]<br>0x3C23D70A|- rd : x23<br> - rs1 : f23<br> - fs1 == 0 and fe1 == 0x78 and fm1 == 0x23d70a and rm_val == 0  #nosat<br>                       |[0x80000288]:fmv.x.w s7, fs7<br> [0x8000028c]:csrrs a7, fflags, zero<br> [0x80000290]:sw s7, 0(a5)<br>       |
|  15|[0x80002274]<br>0xBC23D70A|- rd : x21<br> - rs1 : f0<br> - fs1 == 1 and fe1 == 0x78 and fm1 == 0x23d70a and rm_val == 0  #nosat<br>                        |[0x800002a0]:fmv.x.w s5, ft0<br> [0x800002a4]:csrrs a7, fflags, zero<br> [0x800002a8]:sw s5, 8(a5)<br>       |
|  16|[0x8000227c]<br>0xBDE147AE|- rd : x22<br> - rs1 : f9<br> - fs1 == 1 and fe1 == 0x7b and fm1 == 0x6147ae and rm_val == 0  #nosat<br>                        |[0x800002b8]:fmv.x.w s6, fs1<br> [0x800002bc]:csrrs a7, fflags, zero<br> [0x800002c0]:sw s6, 16(a5)<br>      |
|  17|[0x80002284]<br>0x3F666666|- rd : x13<br> - rs1 : f22<br> - fs1 == 0 and fe1 == 0x7e and fm1 == 0x666666 and rm_val == 0  #nosat<br>                       |[0x800002d0]:fmv.x.w a3, fs6<br> [0x800002d4]:csrrs a7, fflags, zero<br> [0x800002d8]:sw a3, 24(a5)<br>      |
|  18|[0x8000228c]<br>0x3F8CCCCC|- rd : x6<br> - rs1 : f2<br> - fs1 == 0 and fe1 == 0x7f and fm1 == 0x0ccccc and rm_val == 0  #nosat<br>                         |[0x800002e8]:fmv.x.w t1, ft2<br> [0x800002ec]:csrrs a7, fflags, zero<br> [0x800002f0]:sw t1, 32(a5)<br>      |
|  19|[0x80002294]<br>0x3F63D70A|- rd : x5<br> - rs1 : f21<br> - fs1 == 0 and fe1 == 0x7e and fm1 == 0x63d70a and rm_val == 0  #nosat<br>                        |[0x80000300]:fmv.x.w t0, fs5<br> [0x80000304]:csrrs a7, fflags, zero<br> [0x80000308]:sw t0, 40(a5)<br>      |
|  20|[0x8000229c]<br>0x3F7D70A3|- rd : x2<br> - rs1 : f18<br> - fs1 == 0 and fe1 == 0x7e and fm1 == 0x7d70a3 and rm_val == 0  #nosat<br>                        |[0x80000318]:fmv.x.w sp, fs2<br> [0x8000031c]:csrrs a7, fflags, zero<br> [0x80000320]:sw sp, 48(a5)<br>      |
|  21|[0x800022a4]<br>0xBF8CCCCC|- rd : x20<br> - rs1 : f6<br> - fs1 == 1 and fe1 == 0x7f and fm1 == 0x0ccccc and rm_val == 0  #nosat<br>                        |[0x80000330]:fmv.x.w s4, ft6<br> [0x80000334]:csrrs a7, fflags, zero<br> [0x80000338]:sw s4, 56(a5)<br>      |
|  22|[0x800022ac]<br>0x00000000|- rd : x26<br> - rs1 : f30<br>                                                                                                  |[0x80000348]:fmv.x.w s10, ft10<br> [0x8000034c]:csrrs a7, fflags, zero<br> [0x80000350]:sw s10, 64(a5)<br>   |
|  23|[0x800022b4]<br>0x00000000|- rd : x15<br> - rs1 : f27<br>                                                                                                  |[0x8000036c]:fmv.x.w a5, fs11<br> [0x80000370]:csrrs s5, fflags, zero<br> [0x80000374]:sw a5, 0(s3)<br>      |
|  24|[0x800022bc]<br>0x00000000|- rd : x18<br> - rs1 : f1<br>                                                                                                   |[0x80000390]:fmv.x.w s2, ft1<br> [0x80000394]:csrrs a7, fflags, zero<br> [0x80000398]:sw s2, 0(a5)<br>       |
|  25|[0x800022c4]<br>0x00000000|- rd : x7<br> - rs1 : f10<br>                                                                                                   |[0x800003a8]:fmv.x.w t2, fa0<br> [0x800003ac]:csrrs a7, fflags, zero<br> [0x800003b0]:sw t2, 8(a5)<br>       |
|  26|[0x800022cc]<br>0x00000000|- rd : x1<br> - rs1 : f12<br>                                                                                                   |[0x800003c0]:fmv.x.w ra, fa2<br> [0x800003c4]:csrrs a7, fflags, zero<br> [0x800003c8]:sw ra, 16(a5)<br>      |
|  27|[0x800022d4]<br>0x00000000|- rd : x30<br> - rs1 : f16<br>                                                                                                  |[0x800003d8]:fmv.x.w t5, fa6<br> [0x800003dc]:csrrs a7, fflags, zero<br> [0x800003e0]:sw t5, 24(a5)<br>      |
|  28|[0x800022dc]<br>0x00000000|- rd : x8<br> - rs1 : f4<br>                                                                                                    |[0x800003f0]:fmv.x.w fp, ft4<br> [0x800003f4]:csrrs a7, fflags, zero<br> [0x800003f8]:sw fp, 32(a5)<br>      |
|  29|[0x800022e4]<br>0x00000000|- rd : x25<br> - rs1 : f19<br>                                                                                                  |[0x80000408]:fmv.x.w s9, fs3<br> [0x8000040c]:csrrs a7, fflags, zero<br> [0x80000410]:sw s9, 40(a5)<br>      |
|  30|[0x800022ec]<br>0x00000000|- rd : x9<br> - rs1 : f25<br>                                                                                                   |[0x80000420]:fmv.x.w s1, fs9<br> [0x80000424]:csrrs a7, fflags, zero<br> [0x80000428]:sw s1, 48(a5)<br>      |
|  31|[0x800022f4]<br>0x00000000|- rd : x12<br> - rs1 : f14<br>                                                                                                  |[0x80000438]:fmv.x.w a2, fa4<br> [0x8000043c]:csrrs a7, fflags, zero<br> [0x80000440]:sw a2, 56(a5)<br>      |
|  32|[0x800022fc]<br>0x00000000|- rd : x19<br> - rs1 : f13<br>                                                                                                  |[0x80000450]:fmv.x.w s3, fa3<br> [0x80000454]:csrrs a7, fflags, zero<br> [0x80000458]:sw s3, 64(a5)<br>      |
