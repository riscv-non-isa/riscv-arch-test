...
address of the signature (i.e. from RVMODEL_DATA_BEGIN to RVMODEL_DATA_END).  Furthermore, the size
of the signature should be a multiple of 4-bytes (i.e. it should end at a 4-byte boundary). 
