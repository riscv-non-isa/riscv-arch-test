...
|InterruptsSstcSm|Machine Supervisor Timer Compare|<<t-InterruptsSstcSm-coverpoints>>|||x|x|x
|InterruptsSstcS|Supervisor Timer Compare|<<t-InterruptsSstcS-coverpoints>>|||x|x|x
