...
- When verifying results, make sure tests run on all simulators and hit 100% coverage. Also, check that the same traps occur before and after T-SBI, except for changes of removing RVTEST_GOTO_* and of making T-SBI calls.
